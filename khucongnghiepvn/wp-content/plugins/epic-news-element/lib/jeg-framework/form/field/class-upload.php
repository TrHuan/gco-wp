				...
				<div class="upload-wrapper">
					...
					<div class="actions">
						...
						<# if ( data.value && data.value.id ) { #>
							<input   name="{{ data.fieldName }}" class="hidden-field" value="{{{ data.value.id }}}" data-field="{{{ data.fieldID }}}" >
						<# } else { #>
							<input   name="{{ data.fieldName }}" class="hidden-field" value="{{{ data.value }}}" data-field="{{{ data.fieldID }}}" >
						<# } #>
					</div>
				</div>
