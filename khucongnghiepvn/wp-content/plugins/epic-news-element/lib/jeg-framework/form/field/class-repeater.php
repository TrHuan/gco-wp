...
class Repeater extends Field_Abstract {
	...
	public function js_template() {
		...
		<div class="widget-wrapper type-repeater" data-field="{{ data.fieldID }}">
			...
			<input class="widefat data-setting" id="{{ data.fieldID }}" name="{{ data.fieldName }}"   value="{{ value }}" />
		</div>
		<?php
	}
					...
					<# _.each( data, function( field, fieldID ) { #>
						<div class="repeater-field repeater-field-{{{ field.type }}}">
							...
							<# } else if ( 'hidden' === field.type ) { #>
								...
								<input   data-field="{{{ fieldID }}}" <# if ( field.default ) { #> value="{{{ field.default }}}" <# } #> />
							...
							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
								...
								<div class="actions">
									...
									<# if ( field.default.id ) { #>
										<input   class="hidden-field" value="{{{ field.default.id }}}" data-field="{{{ fieldID }}}" >
									<# } else { #>
										<input   class="hidden-field" value="{{{ field.default }}}" data-field="{{{ fieldID }}}" >
									<# } #>
								</div>
