...
if (!function_exists('lth_section_output_fe')) :
    ...
    if ($attributes['color_text']) {
        $text = 'color: '.$attributes['color_text'].';';
    }
?>

    <section class="lth-section <?php echo $attributes['class']; ?>" data-wow-duration="1s" data-wow-delay="0.1s" style="<?php echo $margin_top; ?> <?php echo $margin_bottom; ?> <?php echo $padding_top; ?> <?php echo $padding_bottom; ?> <?php echo $background; ?> <?php echo $text; ?>">
