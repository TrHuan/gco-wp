			...
			<tbody>
				...
				<tr>
					<td colspan="6" class="actions">
						...
						<a href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) ); ?>" title="" class="shop-continue">Tiếp tục mua hàng</a>
