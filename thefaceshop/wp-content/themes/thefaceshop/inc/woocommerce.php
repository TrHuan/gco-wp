...
function lth_bank_details( $order_id = '' ) {
    ...
    if ( ! empty( $bacs_accounts ) ) {
        ...
        <ul class="nav nav-pills text-uppercase py-3 d-flex align-items-center s12 f1 chk-tabs-menu" role="tablist">
            <?php $i;
            foreach ( $bacs_accounts as $bacs_account ) { $i++;
                $bacs_account = (object) $bacs_account;
                
                $bank_name = $bacs_account->bank_name;
                ?>
                <li class="nav-item">
                    <a class="nav-link <?php if ($i == 1) {echo __('active');} ?>" id="pills-home-tab" data-toggle="pill" href="#nv<?php echo $i; ?>" role="tab" aria-controls="pills-home" aria-selected="true">
                        <!-- <img src="<?php echo ASSETS_URI ?>/img/partner8.jpg" title="" alt=""> -->
                        <?php echo $bank_name;?>
                    </a>
                </li>
            <?php } ?>
        ...
        <div class="tab-content chk-tab-scontent" id="pills-tabContent">
            <?php $j;
            foreach ( $bacs_accounts as $bacs_account ) { $j++;
                $bacs_account = (object) $bacs_account;
                ...
                ?>
                <div class="tab-pane fade <?php if ($j == 1) {echo __('show active');} ?>" id="nv<?php echo $j; ?>" role="tabpanel" aria-labelledby="pills-home-tab">
                    <h4 class="pb-3 bold"><?php echo __('Thông tin tài khoản'); ?></h4>
                    <div class="">
                        <p>Chủ TK: <span class="text-uppercase"><?php echo $account_name;?></span></p>
                        <p>Số TK: <span><?php echo $stk;?></span></p> 
                        <p>Chi nhánh: <span><?php echo $bank_branch;?></span></p>
                    </div>
                </div>
            <?php } ?>
        </div>
