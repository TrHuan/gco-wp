...
function lth_theme_styles() {
    ...
    wp_enqueue_style(THEME_NAME . '-raleway', ASSETS_URI . '/css/font-raleway.css', false, THEME_VERSION, 'all');
    wp_enqueue_style(THEME_NAME . '-GaramondPremrProdisplay', ASSETS_URI . '/css/font-GaramondPremrProdisplay.css', false, THEME_VERSION, 'all');
