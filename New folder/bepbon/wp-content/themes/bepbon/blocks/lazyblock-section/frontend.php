...
?>
    ...
    <section class="lth-section" style="<?php echo $margin_top; ?> <?php echo $margin_bottom; ?> <?php echo $padding_top; ?> <?php echo $padding_bottom; ?> <?php echo $background; ?> <?php echo $text; ?>">
