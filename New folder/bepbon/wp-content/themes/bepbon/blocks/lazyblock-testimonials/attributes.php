...
if ( function_exists( 'lazyblocks' ) ) :
   ...
   lazyblocks()->add_block( array(
      ...
      'controls' => array(
         'control_repeater_lth_testimonials' => array(
            'type' => 'repeater',
            'name' => 'testimonials',
            'default' => '',
            'label' => 'Testimonials',
         ...
         'control_image_lth_testimonials_image' => array(
            'type' => 'image',
            'name' => 'image',
            'default' => '',
            'label' => 'Image',
            'help' => '',
            'child_of' => 'control_repeater_lth_testimonials',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
            'save_in_meta' => 'false',
         ...
         'control_textarea_lth_testimonials_title' => array(
            'type' => 'textarea',
         ...
         'control_textarea_lth_testimonials_description' => array(
            'type' => 'textarea',
         ...
         'control_select_lth_slider_style_css' => array(
            'type' => 'select',
            'name' => 'style',
            'default' => 'style-01',
            'label' => 'Style',
            'help' => '',
            'child_of' => 'control_repeater_lth_slider',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
            'save_in_meta' => 'false',
         ...
         'control_select_lth_slider_style' => array(
            'type' => 'select',
            'name' => 'style_slider',
            'default' => 'slider-01',
            'label' => 'Style Slider',
