...
function lth_sidebar_register() {
    ...
    register_sidebar (
        array (
            'name' => __('Sidebar Bottom Content'),
            'id'        => 'sidebar_single_blog_bottom_content',
            'before_widget' => '<div class="sidebar-box">',
            'after_widget' => '</div>',
            'before_title' => '<h3><span>',
            'after_title' => '</span></h3>',
    ...
    register_sidebar (
        array (
            'name' => __('Footer Top'),
            'id'        => 'footer_top',
            'before_widget' => '<div class="footer-box footer-top">',
            'after_widget' => '</div>',
            'before_title' => '<h3>',
            'after_title' => '</h3>',
        )
