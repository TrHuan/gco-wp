...
if (function_exists('lazyblocks')) :
   ...
   lazyblocks()->add_block(array(
      ...
      'controls' => array(
         ...
         'control_repeater_lth_posts_categories' => array(
            'type' => 'repeater',
            'name' => 'categories',
            'default' => '',
            'label' => 'Categories',
         ...
         'control_text_lth_posts_categories' => array(
            'type' => 'text',
            'name' => 'category',
            'default' => '',
            'label' => 'Category',
            'help' => '',
            'child_of' => 'control_repeater_lth_posts_categories',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
            'save_in_meta' => 'false',
         ...
         'control_number_lth_posts_post_number' => array(
            'type' => 'number',
            'name' => 'post_number',
            'default' => '5',
            'label' => 'Post Number',
         ...
         'control_select_lth_posts_orderby' => array(
            'type' => 'select',
            'name' => 'orderby',
            'default' => 'ID',
            'label' => 'Orderby',
         ...
         'control_select_lth_posts_order' => array(
            'type' => 'select',
            'name' => 'order',
            'default' => 'DESC',
            'label' => 'Order',
         ...
         'control_text_lth_posts_text_button' => array(
            'type' => 'text',
            'name' => 'button',
            'default' => '',
            'label' => 'Button',
         ...
         'control_url_lth_posts_url' => array(
            'type' => 'url',
            'name' => 'url_button',
            'default' => '',
            'label' => 'URL',
