...
if ( function_exists( 'lazyblocks' ) ) :
   ...
   $block_fields = array(
      'id'           => 'lth_receive_messages', //thay đổi
      'title'        => 'LTH: Receive Messages', //thay đổi
      ...
      'slug'         => 'lazyblock/lth-receive-messages', //thay đổi
      'category'     => 'common'
   );
   ...
   lazyblocks()->add_block( array(
      ...
      'controls' => array(
         ...
         'control_textarea_lth_features_phone' => array(
            'type' => 'text',
            'name' => 'feature_phone',
            'default' => '',
            'label' => 'Phone',
