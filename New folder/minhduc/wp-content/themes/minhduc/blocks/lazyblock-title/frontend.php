...
?>
    ...
    <?php if ($attributes['title'] || $attributes['description']) : ?>
        <div class="entry-header <?php echo $attributes['class']; ?>">
            <?php if (isset($attributes['title'])) : ?>
                <h2 class="fs-40s title-after__mains titles-bold__alls text-color__blues mb-40s" style="<?php echo $color_title; ?>">
                    <?php if ($attributes['url']) : ?> 
                        <a href="<?php echo esc_url($attributes['url']); ?>" title="" style="<?php echo $color_title; ?>">
                    <?php endif; ?>
                        <?php echo wpautop(__($attributes['title'])); ?>
                    <?php if ($attributes['url']) : ?> 
                        </a>
                    <?php endif; ?>
                </h2>
            ...
            <?php if ($attributes['description']) : ?>
                <div class="infor" style="<?php echo $color_description; ?>">
                    <?php echo wpautop(__($attributes['description'])); ?>
                </div>
            <?php endif; ?>
        </div>
    <?php else : ?>
