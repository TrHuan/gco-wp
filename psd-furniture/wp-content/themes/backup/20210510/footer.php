...
?>
        ...
        <div class="chat-box">
            <ul>
                <li>
                    <a href="<?php the_field('chat_zalo', 'option'); ?>" target="_blank" title="">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon-05.png" alt="Icon">
                    </a>
                </li>
                <li>
                    <a href="tel:<?php the_field('phone_chat', 'option'); ?>" title="">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon-06.png" alt="Icon">
                    </a>
                </li>
            </ul>
        </div>
