...
function remove_logo_and_submenu() {
    ...
    $wp_admin_bar->add_menu( array(
        'id' => 'wp-logo',
        'title' => '<img src="'.get_field('logo', 'option').'" style="height: 32px; position: relative; top: 4px; background: #fff;" />',
        'href' => __('#'),
        'meta' => array(
...
function change_posttype() {
    if( is_archive() && !is_admin() ) {
        set_query_var( 'post_type', array( 'service' ) );
    }
}
