						        		...
						        		<div class="banner-box <?php if ($psab == "yes") { ?>banner-box-content-absolute<?php }?>" <?php if ($psab == "yes") { ?>style="position: relative; display: flex; justify-content: center; align-items: center;"<?php }?>>
						            		<?php if ($image || $video) { ?>
							            		<div class="content-image" <?php if ($psab == "yes") { ?>style="width: 100%;"<?php }?>>
							            			<?php if ($image) { ?>
								            			<div class="image">
								            				<?php if ($url) { ?> <a href="<?php echo $url; ?>" title=""> <?php } ?>
								            					<img src="<?php echo $image; ?>" alt="Banner" style="width: 100%;" width="1920" height="1080">
								            				<?php if ($url) { ?> </a> <?php } ?>
								            			</div>
								            		<?php } ?>
						            		...
						            		<?php if ($content || $countdown || $button == 'yes' || $title) { ?>
						            			<div class="content" <?php if ($psab == "yes") { ?>style="position: absolute; top: <?php echo $top; ?>; bottom: <?php echo $bottom; ?>; left: <?php echo $left; ?>; right: <?php echo $right; ?>;"<?php }?>>

						            				<?php if ($title) { ?>
														<h4 class="title" style="font-size: <?php echo $font_size_title; ?>; font-weight: <?php echo $font_weight_title; ?>; color: <?php echo $color_title; ?>"><?php echo $title; ?></h4>
													<?php }?>
							            				...
							            				<div class="buttons">
							            					<?php if( have_rows('add_buttons') ): ?>
							            						<?php while( have_rows('add_buttons') ): the_row(); ?>
							            							...
							            							?>
									            					<a href="<?php if ($url) { echo $url; } elseif ($url == '#' || !$url) { echo __('javascript:0'); } ?>" class="btn <?php echo $class; ?>" title="<?php echo $text; ?>">
									            						<?php echo $text; ?>
