											...
											?>
												...
												<div class="content">
												    <h4 class="content-name">
												    	<a href="<?php echo esc_url( get_term_link( $cat ) ); ?>" title="<?php echo esc_html( $cat->name ); ?>">
				                                    ...
				                                    <div class="content-button">
				                                    	<a href="<?php echo esc_url( get_term_link( $cat ) ); ?>" title="<?php echo esc_html( $cat->name ); ?>"><?php echo __('Xem thêm'); ?> <i class="icofont-arrow-right icon"></i></a>
				                                    </div>
												</div>
											<?php endif; ?>
										</div>
