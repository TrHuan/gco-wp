...
jQuery(document).ready(function($) {
    ...
    var url_site_data = $('body').attr('url_site_data');
    var slug_post_type_data = $('body').attr('slug_post_type_data');
    var href = url_site_data + slug_post_type_data;

    var hscu = $('.megamenu .menu a[href^="'+ href +'"]').parent().hasClass('current-menu-item');
    if (!hscu) {
        $('.megamenu .menu a[href^="'+ href +'"]').parent().addClass('current-menu-item');
    }
});