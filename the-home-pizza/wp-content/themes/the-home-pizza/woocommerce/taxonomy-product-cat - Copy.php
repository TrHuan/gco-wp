                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <ul>
                            ...
                            foreach ( $terms as $term ) {                            
                                ...
                                if ($slug != 'menu-nha-hang' && $slug != 'menu-giao-hang') { ?>
                                    <li>
                                        <a href="<?php echo get_term_link( $term, $taxonomy_name ); ?>" data_href="<?php echo '#'.$slug; ?>" title="" class="<?php echo $slug; ?>">
                                        ...
                                        if ($child_terms) { ?>
                                            <ul class="categories-sub <?php echo $slug; ?>">
                                                <?php foreach ( $child_terms as $child_term ) { ?>
                                                    <li>
                                                        <a href="<?php echo get_term_link( $child_term, $taxonomy_name ); ?>" data_href="<?php echo '#'.$child_term->slug; ?>">
                    ...
                    <div class="module module_products posts-list">
                        ...
                        foreach ( $terms as $term ) { $i++;                           
                            $slug = $term->slug;
                            if ($slug != 'menu-nha-hang' && $slug != 'menu-giao-hang') { ?>
                                <div id="<?php echo $term->slug;?>" class="products-list-<?php echo $i; ?>">
                                    ...
                                    if ($child_terms) { $j; ?>
                                        <?php foreach ( $child_terms as $child_term ) { $j++; ?>
                                            <div id="<?php echo '#'.$child_term->slug;?>" class="products-list-<?php echo $i.'-'.$j; ?>">
                                                <h3 class="title"><?php echo $child_term->name; ?></h3>

                                                <div class="products-list" id="<?php echo '#'.$child_term->slug;?>">
                                                    <?php
                                                        $args = [
                                                            'post_type' => 'product',
                                                            'post_status' => 'publish',
