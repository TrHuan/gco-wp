...
<ul class="woo-title">
	...
	<li><span><?php echo __('*') ?></span></li>
	<!-- <li><a href="<?php //echo wc_get_checkout_url(); ?>"><?php //echo __('Thanh toán') ?></a></li> -->
	<li><a href="javascript:0"><?php echo __('Thanh toán') ?></a></li>
</ul>

<?php $row_classes     = array();
$main_classes    = array();
