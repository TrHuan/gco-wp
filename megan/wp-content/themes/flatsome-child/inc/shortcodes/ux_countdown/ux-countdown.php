<?php
function remove_x_countdown_parent_theme_shortcodes() {
  // xoá shortcode element cũ bên theme flatsome
  remove_shortcode('ux_countdown');

  // add shortcode element mới bên theme flatsome-child
  add_shortcode('ux_countdown', 'gco_ux_countdown_shortcode');

}
add_action('init', 'remove_x_countdown_parent_theme_shortcodes');
...
// Register Shortcode
function gco_ux_countdown_shortcode( $atts ){
