...
add_ux_builder_shortcode('flatsome_type', array(
        ...
        'styles' => array(
            ...
            'gco-slick-style' => LTH_CHILD_URI . '/assets/css/slick.min',
            'gco-elements-style' => LTH_CHILD_URI . '/assets/css/gco-elements',
        ),
        'scripts' => array(
            // 'gco-jquery-script' => LTH_CHILD_URI . '/assets/js/jquery.min',
            'gco-slick-script' => LTH_CHILD_URI . '/assets/js/slick.min',
            'gco-elements-script' => LTH_CHILD_URI . '/assets/js/gco-elements',
        ),
        'options' => array(
