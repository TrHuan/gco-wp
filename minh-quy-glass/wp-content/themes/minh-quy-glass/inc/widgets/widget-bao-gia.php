<?php
  ...
  */
  ...
  add_action( 'widgets_init', 'create_widget_quotes' );

  function create_widget_quotes() {

    register_widget('Widget_Quotes');
  ...
  * Tạo class Widget_Quotes

  */

  class Widget_Quotes extends WP_Widget {
    ...
    */
    ...
    function __construct() {
      ...
      parent::__construct (
        ...
        'widget_quotes', // id của widget

        'Báo Giá', // tên của widget
    ...
    */
    ...
    function widget( $args, $instance ) { 
      ...
      echo '<div class="sidebar-quotess-box">';
        ...
        <ul>
          <?php if ($wp_query->have_posts()) {
            ...
            while ($wp_query->have_posts()) {
              ...
              get_template_part('template-parts/bao-gia/content', 'sidebar');
