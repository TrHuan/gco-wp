jQuery(document).ready(function($) {
    ...
    $('.video-gallery .video-fancybox').click(function(e){
        e.preventDefault();

        $('.popup-video').addClass('active');
    });

    $('.popup-video .pp_close').click(function(e){
        e.preventDefault();

        $('.popup-video').removeClass('active');

        var iff = $('.popup-video iframe').attr('src');

        $('.popup-video iframe').attr('src', '');

        $('.popup-video iframe').attr('src', iff);
    });
    ...
    if (data_url) {
        $('.main-menu .navigation li a[href^="'+data_url+'"]').parent().addClass('current_page_parent');
    } else {
