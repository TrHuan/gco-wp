		                    ...
		                    <?php
								...
								if ( $terms && ! is_wp_error( $terms ) ) :
								    ...
								    foreach ( $terms as $term ) { ?>
								        ...
								        <a href="<?php echo get_term_link($term, 'thi-cong-cat'); ?>" title="<?php echo $cat = $term->name;; ?>"><?php echo $cat = $term->name;; ?></a>
...
<!--Start related project items-->
    <div class="related-project-items">
        <div class="sec-title text-center">
            <h2><?php echo __('Dựa án liên quan') ?></h2>
        </div>
		        ...
		        <div class="col-md-4">
		            <div class="single-project-item">
		                ...
		                <div class="text-holder">
		                    ...
		                    <p>
		                    	<?php
		                    		$terms = get_the_terms( $post, 'thi-cong-cat' );
