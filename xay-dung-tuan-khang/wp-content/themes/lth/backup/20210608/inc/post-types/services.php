...
function create_service_item() {
	$labels = array(
		'name' => _x('Thiết kế nội thất', 'post type general name'),
		'singular_name' => _x('Thiết kế nội thất', 'post type singular name'),
		'add_new' => _x('Mới', 'service'),
		'add_new_item' => __('Thiết kế nội thất'),
		'edit_item' => __('Thiết kế nội thất'),
		'new_item' => __('Mới'),
		'all_items' => __('Tất cả Thiết kế nội thất'),
		'view_item' => __('Xem'),
		'search_items' => __('Tìm kiếm'),
		'not_found' =>  __('No Service found'),
		'not_found_in_trash' => __('No Service found in Trash'), 
		'parent_item_colon' => '',
		'menu_name' => 'Thiết kế nội thất'
	);
