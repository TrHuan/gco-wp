...
<div class="row">
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="popup-video">
            <div class="content">
                <iframe width="560" height="315" src="<?php echo $url_video_url; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
