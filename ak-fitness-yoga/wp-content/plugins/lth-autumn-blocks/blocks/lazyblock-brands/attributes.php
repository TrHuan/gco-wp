...
if (function_exists('lazyblocks')) :
   ...
   lazyblocks()->add_block(array(
      ...
      'controls' => array(
         'control_repeater_lth_brands' => array(
            'type' => 'repeater',
            'name' => 'brands',
            'default' => '',
            'label' => 'Brands',
         ...
         'control_image_lth_brand_image' => array(
            'type' => 'image',
            'name' => 'image',
            'default' => '',
            'label' => 'Image',
            'help' => '',
            'child_of' => 'control_repeater_lth_brands',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
            'save_in_meta' => 'false',
         ...
         'control_image_lth_brand_url' => array(
            'type' => 'url',
            'name' => 'url',
            'default' => '',
            'label' => 'Url',
         ...
         'control_select_lth_brands_style_css' => array(
            'type' => 'select',
            'name' => 'style',
            'default' => 'style-01',
            'label' => 'Style',
