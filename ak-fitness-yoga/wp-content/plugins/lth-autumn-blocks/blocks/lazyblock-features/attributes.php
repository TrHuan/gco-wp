...
if ( function_exists( 'lazyblocks' ) ) :
   ...
   lazyblocks()->add_block( array(
      ...
      'controls' => array(
         'control_repeater_lth_features' => array(
            'type' => 'repeater',
            'name' => 'features',
            'default' => '',
            'label' => 'Features',
         ...
         'control_image_lth_features_image' => array(
            'type' => 'image',
            'name' => 'image',
            'default' => '',
            'label' => 'Image',
            'help' => '',
            'child_of' => 'control_repeater_lth_features',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
            'save_in_meta' => 'false',
         ...
         'control_textarea_lth_features_class_icon' => array(
            'type' => 'text',
            'name' => 'feature_class_icon',
            'default' => '',
            'label' => 'Class Icon',
            'help' => '',
            'child_of' => 'control_repeater_lth_features',
         ...
         'control_textarea_lth_features_title' => array(
            'type' => 'textarea',
            'name' => 'feature_title',
            'default' => '',
            'label' => 'Title',
         ...
         'control_textarea_lth_features_description' => array(
            'type' => 'textarea',
