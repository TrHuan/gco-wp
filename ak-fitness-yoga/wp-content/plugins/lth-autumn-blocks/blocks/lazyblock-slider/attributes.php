...
if ( function_exists( 'lazyblocks' ) ) :
   ...
   lazyblocks()->add_block( array(
      ...
      'controls' => array(
         'control_repeater_lth_slider' => array(
            'type' => 'repeater',
            'name' => 'slider',
            'default' => '',
            'label' => 'Slider',
         ...
         'control_image_lth_slider_image' => array(
            'type' => 'image',
            'name' => 'image',
            'default' => '',
            'label' => 'Image',
         ...
         // 'control_textarea_lth_slider_text_top' => array(
         //    'type' => 'textarea',
         //    'name' => 'text_top',
         //    'default' => '',
         //    'label' => 'Text Top',
         ...
         //    'characters_limit' => '',
         // ),
         // 'control_textarea_lth_slider_text_title' => array(
         //    'type' => 'textarea',
         //    'name' => 'text_title',
         //    'default' => '',
         //    'label' => 'Text Title',
         ...
         //    'characters_limit' => '',
         // ),
         // 'control_textarea_lth_slider_text_bottom' => array(
         //    'type' => 'textarea',
         //    'name' => 'text_bottom',
         //    'default' => '',
         //    'label' => 'Text Bottom',
