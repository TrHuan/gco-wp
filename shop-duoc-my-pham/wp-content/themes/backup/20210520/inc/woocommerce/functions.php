...
function custom_override_checkout_fields( $fields ) { 
    ...
    $fields['billing']['billing_last_name'] = array(
        ...
        'placeholder' => _x('', 'placeholder', 'lth'),
        'required' => true,
        'class' => array('form-row-wide'),
        'clear' => true
    );

    // $fields['billing']['billing_address_1'] = 'Địa chỉ';
    // $fields['billing']['billing_address_2']['placeholder'] = 'Địa chỉ 2';
    ...
    // $fields['shipping']['shipping_address_1'] = 'Địa chỉ';
    // $fields['shipping']['shipping_address_2']['placeholder'] = 'Địa chỉ 2';
...
function lth_bank_details( $order_id = '' ) {
    ...
    if ( ! empty( $bacs_accounts ) ) {
        ...
        echo '<div>';
        ?>
        <h4><strong><?php echo __('Hiện nay chúng tôi hỗ trợ các ngân hàng sau:'); ?></strong></h4>

        <ul class="bank-tab-title">            
            <?php $i;
            foreach ( $bacs_accounts as $bacs_account ) { $i++;
                ...
                ?>
                <li style="border: 1px solid #ebebeb;padding: 10px 15px;" class="<?php if ($i == 1) {echo 'active';} ?>">
                    <input type="radio" name="bank" <?php if ($i == 1) {echo 'checked';} ?> bank_data="<?php echo $bank_name;?>">
                    <p><strong><?php echo $bank_name;?></strong></p>
                </li>
            <?php } ?>
        </ul>

        <ul class="bank-tab-content">
            <?php $j;
            foreach ( $bacs_accounts as $bacs_account ) { $j++;
                ...
                <?php //if (!$bank_name) { ?>
                <li style="border: 1px solid #ebebeb;padding: 10px 15px;" class="<?php if ($j == 1) {echo 'active';} ?>" bank_data="<?php echo $bank_name;?>">
                <?php //} ?>
