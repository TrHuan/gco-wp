...
if ( function_exists( 'lazyblocks' ) ) :
   ...
   lazyblocks()->add_block( array(
      ...
      'controls' => array(
         'control_repeater_lth_gallery' => array(
            'type' => 'repeater',
            'name' => 'gallery',
            'default' => '',
            'label' => 'Gallery',
         ...
         'control_image_lth_gallery_image' => array(
            'type' => 'image',
            'name' => 'image',
            'default' => '',
            'label' => 'Image',
            'help' => '',
            'child_of' => 'control_repeater_lth_gallery',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
            'save_in_meta' => 'false',
         ...
         'control_repeater_lth_favorite' => array(
            'type' => 'repeater',
            'name' => 'favorite',
            'default' => '',
            'label' => 'Favorite',
         ...
         'control_image_lth_favorite_image' => array(
            'type' => 'image',
            'name' => 'favorite_image',
            'default' => '',
            'label' => 'Favorite Image',
            'help' => '',
            'child_of' => 'control_repeater_lth_favorite',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
            'save_in_meta' => 'false',
         ...
         'control_image_lth_favorite_text' => array(
            'type' => 'text',
            'name' => 'favorite_text',
            'default' => '',
            'label' => 'Favorite Text',
         ...
         'control_image_lth_favorite_url' => array(
            'type' => 'url',
            'name' => 'favorite_url',
            'default' => '',
            'label' => 'Favorite Url',
