...
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<div class="row">
		<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
			...
			<h3 id="order_review_heading"><?php esc_html_e( '2. Phương thức thanh toán', 'woocommerce' ); ?></h3>
		...
		<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
			<h3 id="order_review_heading"><?php esc_html_e( '3. Đơn hàng của bạn', 'woocommerce' ); ?></h3>
			...
			<a href="<?php echo wc_get_cart_url(); ?>" title="Back" style="margin-top: 20px; display: inline-block;"><?php echo __('(Xem lại giỏ hàng)'); ?></a>
