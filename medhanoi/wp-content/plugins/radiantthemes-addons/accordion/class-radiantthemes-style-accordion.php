...
if ( ! class_exists( 'RadiantThemes_Style_Accordion' ) ) {
	...
	class RadiantThemes_Style_Accordion {
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Style Four (Boxed Numbered Style - Light)', 'radiantthemes-addons' )  => 'four',
							),
							'std'         => 'one',
							'admin_label' => true,
						),
		...
		public function radiantthemes_accordion_style_func( $atts, $content = null, $tag ) {
			...
			// ADD CUSTOM CSS.
			$custom_css = $shortcode['accordion_color'] ? '.radiantthemes-accordion.element-three.' . $random_class . ' .radiantthemes-accordion-item.radiantthemes-active > .radiantthemes-accordion-item-title{
            	background-color: ' . $shortcode['accordion_color'] . ' ;
			}
			.radiantthemes-accordion.element-one.' . $random_class . ' .radiantthemes-accordion-item > .radiantthemes-accordion-item-title > .radiantthemes-accordion-item-title-icon i,
            ...
            .radiantthemes-accordion.element-three.' . $random_class . ' .radiantthemes-accordion-item > .radiantthemes-accordion-item-title > .panel-title,
            ...
            .radiantthemes-accordion.element-four.' . $random_class . ' .radiantthemes-accordion-item > .radiantthemes-accordion-item-title > .panel-title > .panel-title-counter{
