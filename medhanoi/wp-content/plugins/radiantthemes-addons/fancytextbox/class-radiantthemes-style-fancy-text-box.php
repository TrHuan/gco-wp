	...
	class RadiantThemes_Style_Fancy_Text_Box extends WPBakeryShortCode {
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Style Twelve (Icon Left Shadow)', 'radiantthemes-addons' )                           => 'twelve',
								esc_html__( 'Style Thirteen (Overlay Hover With Button)', 'radiantthemes-addons' )                => 'thirteen',
							),
							'std'         => 'one',
							'admin_label' => true,
						),
		...
		public function radiantthemes_fancy_text_box_style_func( $atts, $content = null, $tag ) {
			...
			if ( ! empty( $shortcode['fancy_textbox_color'] ) ) {
				...
				.rt-fancy-text-box.element-nine.{$random_class} > .holder > .icon i,
				...
				.rt-fancy-text-box.element-thirteen.{$random_class} > .holder:before{
