...
class Radiantthemes_Twitter_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__( 'RadiantThemes Twitter Widget', 'apexclinic' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Widget for twitter box.', 'apexclinic' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$username    = ! empty( $instance['username'] ) ? $instance['username'] : esc_html__( 'twitter', 'apexclinic' );
		$maxtweets   = ! empty( $instance['maxtweets'] ) ? $instance['maxtweets'] : esc_html__( '5', 'apexclinic' );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'apexclinic' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" />
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'maxtweets' ) ); ?>"><?php esc_html_e( 'No. of Maximum Tweets:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'enablelinks' ) ); ?>"><?php esc_html_e( 'Enable Links:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'showuser' ) ); ?>"><?php esc_html_e( 'Show User:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'showtime' ) ); ?>"><?php esc_html_e( 'Show Time:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'showimages' ) ); ?>"><?php esc_html_e( 'Show Images:', 'apexclinic' ); ?></label>
