...
class Radiantthemes_Contact_Box_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__( 'RadiantThemes Contact Box', 'apexclinic' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Contact box for footer area.', 'apexclinic' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$addressdata  = ! empty( $instance['addressdata'] ) ? $instance['addressdata'] : esc_html__( '123 6th St. Melbourne, FL 32904', 'apexclinic' );
		$phonenumber  = ! empty( $instance['phonenumber'] ) ? $instance['phonenumber'] : esc_html__( 'Phone: (888) 123-4567', 'apexclinic' );
		$emailid      = ! empty( $instance['emailid'] ) ? $instance['emailid'] : esc_html__( 'Email: info@example.com', 'apexclinic' );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'contacttitledata' ) ); ?>"><?php esc_html_e( 'Title:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'addressdata' ) ); ?>"><?php esc_html_e( 'Address:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'phonenumber' ) ); ?>"><?php esc_html_e( 'Phone Number:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'emailid' ) ); ?>"><?php esc_html_e( 'Email ID:', 'apexclinic' ); ?></label>
...
/**
 * [apexclinic_contact_box_load_widget description]
 */
