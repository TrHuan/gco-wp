...
class Radiantthemes_Facebook_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__( 'RadiantThemes Facebook Page Box', 'apexclinic' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Widget for facebook box.', 'apexclinic' ),
			)
		);
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'page-url' ) ); ?>"><?php esc_html_e( 'Page URL:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'page-tabs' ) ); ?>"><?php esc_html_e( 'Tabs to render i.e. events, messages(timeline is default):', 'apexclinic' ); ?></label>
			...
			<label><?php esc_html_e( 'Events', 'apexclinic' ); ?></label>
			...
			<label><?php esc_html_e( 'Messages', 'apexclinic' ); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Width:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'small_header' ) ); ?>"><?php esc_html_e( 'Use the small header instead:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'adapt_container_width' ) ); ?>"><?php esc_html_e( 'Try to fit inside the container width:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'hide_cover' ) ); ?>"><?php esc_html_e( 'Hide cover photo in the header:', 'apexclinic' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_facepile' ) ); ?>"><?php esc_html_e( 'Show profile photos when friends like this:', 'apexclinic' ); ?></label>
