...
if ( class_exists( 'WPBakeryShortCode' ) && ! class_exists( 'Radiantthemes_Style_Button' ) ) {
	...
	class Radiantthemes_Style_Button extends WPBakeryShortCode {
		...
		public function radiantthemes_button_style_func( $atts, $content = null, $tag ) {
			...
			// HOVER STYLE ONE.
			if ( 'one' === apexclinic_global_var( 'button_hover_style', '', false ) ) {
				...
				// HOVER STYLE TWO.
			} elseif ( 'two' === apexclinic_global_var( 'button_hover_style', '', false ) ) {
				...
				// HOVER STYLE THREE.
			} elseif ( 'three' === apexclinic_global_var( 'button_hover_style', '', false ) ) {
				...
				// HOVER STYLE FOUR.
			} elseif ( 'four' === apexclinic_global_var( 'button_hover_style', '', false ) ) {
			...
			$output .= '<div class="radiantthemes-button hover-style-' . esc_attr( apexclinic_global_var( 'button_hover_style', '', false ) ) . ' ' . $animation_classes . ' ' . esc_attr( $shortcode['extra_class'] ) . '" ' . $button_id . ' data-button-direction="' . $shortcode['align'] . '"';
