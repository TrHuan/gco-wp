				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Style One (Cover Details)', 'radiantthemes-addons' )    => 'one',
								esc_html__( 'Style Two (Overlay Details)', 'radiantthemes-addons' )  => 'two',
								esc_html__( 'Style Three (Details Style)', 'radiantthemes-addons' )  => 'three',
								esc_html__( 'Style Four (Classic Style)', 'radiantthemes-addons' )   => 'four',
								esc_html__( 'Style Five (Creative Style)', 'radiantthemes-addons' )  => 'five',
								esc_html__( 'Style Six (Overlay ZoomIn)', 'radiantthemes-addons' )   => 'six',
								esc_html__( 'Style Seven (Hover Shadow)', 'radiantthemes-addons' )   => 'seven',
							),
							'std'        => 'one',
						),
						array(
							'type'        => 'textfield',
							'heading'     => esc_html__( 'Team Profession', 'radiantthemes-addons' ),
							'description' => esc_html__( 'Display posts from a specific profession (enter Profession category slug name). Use "all" to dislay all posts. ', 'radiantthemes-addons' ),
