...
$output .= '<button class="matchHeight current-menu-item" data-filter="*"><span>' . esc_html( 'All Groups', 'radiantthemes-addons' ) . '</span></button>';
...
if ( $my_query->have_posts() ) {
	while ( $my_query->have_posts() ) :
		...
		$output .= '<img src="' . plugins_url( 'radiantthemes-addons/case-studies/images/blank-image-100x65.jpg' ) . '" alt="blank image" width="100" height="65">';
