...
require_once 'currency-converter/class-radiantthemes-currency-converter.php';
...
if ( ! class_exists( 'Radiantthemes_Addons' ) ) {
	...
	class Radiantthemes_Addons {
		...
		public function __construct() {
			...
			if ( ! function_exists( 'rt_currency_converter_func' ) ) {
				new RadiantThemes_Currency_Converter();
			}
