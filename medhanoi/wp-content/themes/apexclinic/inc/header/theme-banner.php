...
if ( is_front_page() && is_home() ) { ?>
	...
	<div class="wraper_inner_banner">
		...
		<?php if ( ! ( is_front_page() && is_home() ) && ! is_page() ) : ?>
			<?php if ( function_exists( 'apexclinic_breadcrumbs' ) ) : ?>
...
<?php } elseif ( is_front_page() ) { ?>
	...
	<?php } ?>
		<?php
		if (
			( 'Banner-With-Breadcrumb' === apexclinic_global_var( 'short-header', '', false ) ) ||
			( 'Banner-only' === apexclinic_global_var( 'short-header', '', false ) )
		) {
		?>
		<!-- wraper_inner_banner_main -->
			<div class="wraper_inner_banner_main">
			...
			if (
				( 'Banner-With-Breadcrumb' === apexclinic_global_var( 'short-header', '', false ) ) ||
				( 'breadcrumb-only' === apexclinic_global_var( 'short-header', '', false ) )
			) {
			?>
			<!-- wraper_inner_banner_breadcrumb -->
			<div class="wraper_inner_banner_breadcrumb">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_breadcrumb">
								<?php
								if ( function_exists( 'apexclinic_breadcrumbs' ) ) {
									apexclinic_breadcrumbs();
								}
								?>
							</div>
							<!-- inner_banner_breadcrumb -->
...
<?php } elseif ( class_exists( 'Tribe__Events__Main' ) && ( is_singular( 'tribe_events' ) || ( tribe_is_past() || tribe_is_upcoming() && ! is_tax() ) || ( tribe_is_month() && ! is_tax() ) || ( tribe_is_day() && ! is_tax() ) ) ) { ?>
		<!-- wraper_header_bannerinner -->
		<?php
		if ( apexclinic_global_var( 'event_banner_image', 'url', true ) ) {
			$event_banner_image_link = esc_url( apexclinic_global_var( 'event_banner_image', 'url', true ) );
		?>
		...
		<?php } ?>
			<?php
			if (
			( 'banner-breadcumbs' == apexclinic_global_var( 'events_banner_details', '', false ) ) ||
			( 'banner-only' === apexclinic_global_var( 'events_banner_details', '', false ) )
			) {
			?>
			<!-- wraper_inner_banner_main -->
			<div class="wraper_inner_banner_main">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								<?php
								if ( empty( apexclinic_global_var( 'event_banner_title', '', false ) ) &&
									empty( apexclinic_global_var( 'event_banner_subtitle', '', false ) ) ) :
									?>
									<p class="title">
										<?php echo esc_html( get_bloginfo( 'name' ) ); ?>
									</p>
								...
								<?php else : ?>
									<?php if ( apexclinic_global_var( 'event_banner_title', '', false ) ) { ?>
									<p class="title">
										<?php echo esc_html( apexclinic_global_var( 'event_banner_title', '', false ) ); ?>
									</p>
									<?php } else { ?>
									<p class="title">
										<?php echo esc_html__( 'Events', 'apexclinic' ); ?>
									</p>
									<?php } ?>
									<?php if ( apexclinic_global_var( 'event_banner_subtitle', '', false ) ) { ?>
									<p class="subtitle">
										<?php echo esc_html( apexclinic_global_var( 'event_banner_subtitle', '', false ) ); ?>
									</p>
									<?php } ?>
								<?php endif; ?>
							</div>
			...
			if (
			( 'banner-breadcumbs' == apexclinic_global_var( 'events_banner_details', '', false ) ) ||
			( 'breadcumbs-only' === apexclinic_global_var( 'events_banner_details', '', false ) )
			) {
			?>
			<!-- wraper_inner_banner_breadcrumb -->
			<div class="wraper_inner_banner_breadcrumb">
								...
								<?php if ( is_category() ) : ?>
									<p class="title">
										...
										printf(
											...
											esc_html__( 'Category Archives: %s', 'apexclinic' ),
								...
								<?php elseif ( is_author() ) : ?>
									<p class="title">
										...
										printf(
											...
											esc_html__( 'All posts by %s', 'apexclinic' ),
								...
								<?php elseif ( is_tag() ) : ?>
									<p class="title">
										...
										printf(
											...
											esc_html__( 'Tag Archives: %s', 'apexclinic' ),
								...
								<?php elseif ( is_archive() ) : ?>
									<p class="title">
										...
										if ( is_day() ) :
											printf(
												// translators: Date.
												esc_html__( 'Daily Archives: %s', 'apexclinic' ),
												get_the_date()
											);
										elseif ( is_month() ) :
											printf(
												// translators: Month and Date.
												esc_html__( 'Monthly Archives: %s', 'apexclinic' ),
												get_the_date( _x( 'F Y', 'monthly archives date format', 'apexclinic' ) )
											);
										elseif ( is_year() ) :
											printf(
												// translators: Month Date, Year.
												esc_html__( 'Yearly Archives: %s', 'apexclinic' ),
												get_the_date( _x( 'Y', 'yearly archives date format', 'apexclinic' ) )
											);
										else :
											esc_html__( 'Archives', 'apexclinic' );
										endif;
										?>
									</p>
								<?php else : ?>
...
<?php } elseif ( is_search() ) { ?>
		...
		?>
		<?php
		if ( apexclinic_global_var( 'search_page_banner_image', 'url', true ) ) {
			$search_page_banner_image_link = esc_url( apexclinic_global_var( 'search_page_banner_image', 'url', true ) );
		?>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								<?php
								if ( empty( apexclinic_global_var( 'search_page_banner_title', '', false ) ) &&
									empty( apexclinic_global_var( 'search_page_banner_subtitle', '', false ) ) ) :
									?>
									<p class="title">
										<?php echo esc_html( get_bloginfo( 'name' ) ); ?>
									</p>
								...
								<?php else : ?>
									<?php if ( apexclinic_global_var( 'search_page_banner_title', '', false ) ) { ?>
									<p class="title">
										<?php echo esc_html( apexclinic_global_var( 'search_page_banner_title', '', false ) ); ?>
									</p>
									<?php } else { ?>
									<p class="title">
										<?php echo esc_html__( 'Search', 'apexclinic' ); ?>
									</p>
									<?php } ?>
									<?php if ( apexclinic_global_var( 'search_page_banner_subtitle', '', false ) ) { ?>
									<p class="subtitle">
										<?php echo esc_html( apexclinic_global_var( 'search_page_banner_subtitle', '', false ) ); ?>
									</p>
									<?php } ?>
								<?php endif; ?>
							</div>
