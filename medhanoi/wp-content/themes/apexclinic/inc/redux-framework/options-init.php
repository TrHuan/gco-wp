	...
	$opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'default'  => esc_html__( 'ApexClinic - 2020', 'apexclinic' ),
			),
	...
	$opt_name, array(
		...
		'fields'     => array(
			...
			array(
				'id'       => 'display_date',
				'type'     => 'switch',
				'title'    => esc_html__( 'Published Date', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select if you want to show published date on Blog Details Page and also applicable for default blog structure.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			array(
				'id'       => 'prefix_date',
				'type'     => 'text',
				'title'    => esc_html__( 'Add a Published Date Prefix Text', 'apexclinic' ),
