...
function apexclinic_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'source'   => 'https://apexclinic.radiantthemes.com/plugins/radiantthemes-custom-post-type.zip',
			'required' => true,
			'version'  => '1.2.1',
		),
		...
		array(
			...
			'source'   => 'https://apexclinic.radiantthemes.com/plugins/radiantthemes-addons.zip',
			'required' => true,
			'version'  => '1.2.7',
		),
		...
		array(
			...
			'source'   => 'https://apexclinic.radiantthemes.com/plugins/radiantthemes-mega-menu.zip',
			'required' => false,
			'version'  => '1.2.0',
		),
