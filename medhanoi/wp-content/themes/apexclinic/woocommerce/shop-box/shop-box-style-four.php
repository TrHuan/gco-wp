...
<div <?php post_class( 'radiantthemes-shop-box matchHeight style-four' ); ?>>
    <div class="holder">
        <?php if ( $product->is_on_sale() ) { ?>
            <?php echo apply_filters( 'woocommerce_sale_flash', '<span class="onsale">' . esc_html__( 'Sale!', 'apexclinic' ) . '</span>', $post, $product ); ?>
        <?php } ?>
        <div class="pic">
            <img src="<?php echo get_parent_theme_file_uri( '/images/blank/Blank-Image-100x123.png' ); ?>" alt="<?php echo esc_attr__( 'Blank Image', 'apexclinic' ) ?>" width="100" height="123">
