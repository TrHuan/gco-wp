...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'style-three' ); ?>>
	<div class="row">
		<?php if ( true == apexclinic_global_var( 'display_categries', '', false ) ) : ?>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="post-thumbnail">
				<img src="<?php echo esc_url( get_parent_theme_file_uri( '/images/no-image/No-Image-Found-400x264.png' ) ); ?>" alt="<?php echo esc_attr__( 'No Image Found', 'apexclinic' ); ?>" width="400" height="264">
