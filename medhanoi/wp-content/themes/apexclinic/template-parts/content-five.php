	...
	<div class="holder">
		...
		<?php if ( has_post_thumbnail() ) { ?>
			<div class="post-thumbnail">
				<img src="<?php echo esc_url( get_parent_theme_file_uri( '/images/blank/Blank-Image-100x65.png' ) ); ?>" alt="<?php echo esc_attr__( 'Blank Image', 'apexclinic' ); ?>" width="100" height="65">
