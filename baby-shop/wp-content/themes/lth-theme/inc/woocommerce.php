...
function woocommerce_header_add_to_cart_fragment_icon( $fragments_icon ) {
    ...
    $fragments_icon['.carts-content .cart-icon'] = ob_get_clean();
...
function custom_override_checkout_fields( $fields ) { 
    ...
    $fields['billing']['billing_phone'] = array(
        ...
        'placeholder' => _x('Nhập số điện thoại của bạn', 'placeholder', 'lth'),
        'required' => true,
        'class' => array('form-row-wide'),
        'clear' => true
    );
    ...
    $fields['shipping']['shipping_phone'] = array(
        'label' => __('Số điện thoại', 'lth'),
        'placeholder' => _x('Nhập số điện thoại của người nhận', 'placeholder', 'lth'),
        'required' => true,
        'class' => array('form-row-wide'),
        'clear' => true
    );

    $fields['shipping']['billing_phone']['placeholder'] = 'Số điện thoại';
...
function lth_bank_details( $order_id = '' ) {
    ...
    if ( ! empty( $bacs_accounts ) ) {
        ...
        echo '<div>';
        ?>
        <h4><?php echo __('Thông tin chuyển khoản'); ?></h4>
        ...
        <ul class="tab-title">
            ...
            foreach ( $bacs_accounts as $bacs_account ) { $i++;
                ...
                ?>
                <li style="border: 1px solid #ebebeb;padding: 10px 15px;" class="tab-<?php echo $i; ?> <?php if ($i == 1){echo 'active';} ?>">
        ...
        <ul class="tab-content">
            ...
            foreach ( $bacs_accounts as $bacs_account ) { $j++;
                ...
                <li style="border: 1px solid #ebebeb;padding: 10px 15px;" class="tab-<?php echo $j; ?> <?php if ($j == 1){echo 'active';} ?>">
