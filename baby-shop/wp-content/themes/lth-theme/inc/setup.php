...
function lth_sidebar_register() {
    ...
    register_sidebar (
        array (
            'name' => __('Sidebar Giới Thiệu'),
            'id'        => 'sidebar_about',
            'before_widget' => '<div class="sidebar-box sidebar-about">',
            'after_widget' => '</div>',
            'before_title' => '<h3>',
            'after_title' => '</h3>',
        )
    ...
    register_sidebar (
        array (
            'name' => __('Blocks Danh Mục'),
            'id'        => 'sidebar_blocks_categories',
            'before_widget' => '<div class="sidebar-box">',
            'after_widget' => '</div>',
            'before_title' => '<h3>',
            'after_title' => '</h3>',
    ...
    register_sidebar (
        array (
            'name' => __('Blocks Thương Hiệu'),
            'id'        => 'sidebar_blocks_trademark',
            'before_widget' => '<div class="sidebar-box sidebar-trademark">',
            'after_widget' => '</div>',
            'before_title' => '<h3>',
            'after_title' => '</h3>',
        )
    ...
    register_sidebar (
        array (
            'name' => __('Footer 1'),
            'id'        => 'widget_footer_1',
            'before_widget' => '<div class="footer-box single-footer">',
            'after_widget' => '</div>',
            'before_title' => '<h3>',
            'after_title' => '</h3>',
        )
...
function lth_admin_menu( $__return_true ) {
    return array(
        ...
        'edit.php?post_type=html-blocks', // header-footer
