...
$agency_phone = get_field('investor_hotline');
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    <div class="agent-profile-top-wrap">
                        ...
                        <?php get_template_part('template-parts/realtors/investor/address'); ?>
                    </div>

                    <div class="agent-profile-content">
                        <ul class="list-unstyled">
                            <?php get_template_part('template-parts/realtors/investor/license'); ?>
                            <?php get_template_part('template-parts/realtors/investor/tax-number'); ?>
                        </ul>
                    ...
                    <div class="agent-profile-buttons">
                        ...
                        <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#realtor-form">
                            <?php echo esc_html__('Gửi Email', 'houzez'); ?>
                        </button>
                        <?php } ?>
                        ...
                        <a href="tel:<?php echo esc_attr($agency_phone_call); ?>">
                            <button type="button" class="btn btn-call">
                                <span class="hide-on-click"><?php echo esc_html__('GỌI', 'houzez'); ?></span>
        ...
        <div class="agent-stats-wrap">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <?php get_template_part('template-parts/realtors/investor/stats-property-types'); ?> 
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <?php get_template_part('template-parts/realtors/investor/stats-property-status'); ?> 
                </div>

                <?php if(taxonomy_exists('property_city')) { ?>
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <?php get_template_part('template-parts/realtors/investor/stats-property-cities'); ?> 
                </div>
                <?php } ?>
            </div>
        ...
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div class="agent-bio-wrap">
                    <h2><?php echo esc_html__('Giới thiệu: ', 'houzez'); ?> <?php the_title(); ?></h2>
                    <?php the_content(); ?>

                    <?php get_template_part('template-parts/realtors/investor/languages'); ?>
                </div><!-- agent-bio-wrap -->
                <?php } ?>
                        ...
                        <div class="listing-tools-wrap">
                            <div class="d-flex align-items-center">
                                <div class="listing-tabs flex-grow-1">
                                    <?php get_template_part('template-parts/realtors/investor/listing-tabs'); ?> 
                                </div>
                                <?php get_template_part('template-parts/realtors/investor/listing-sort-by'); ?>   
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-12 bt-sidebar-wrap <?php echo esc_attr($is_sticky); ?>">
                <aside class="sidebar-wrap">
                    <?php get_template_part('template-parts/realtors/investor/agency-contacts'); ?> 
                    <?php 
