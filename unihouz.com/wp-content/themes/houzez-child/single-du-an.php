...
if($is_full_width == 1) {
    $content_classes = 'col-lg-12 col-sm-12 bt-full-width-content-wrap';
} else {
    $content_classes = 'col-lg-8 col-sm-12 bt-content-wrap';
}
        ...
        <section class="single-project">
            ...
            ?>
                <div class="project-slider" id="project-slider">
                    <div class="slick-carousel" data-item="4" data-item_md="4" data-item_sm="4" data-item_mb="1" data-row="1" data-dots="false" data-arrows="true" data-vertical="false">
            ...
            <?php endif; ?>
            <?php 
            get_template_part('property-details/project-navigation'); 
                    ...
                    <div class="<?php echo esc_attr($content_classes); ?>">
                        ...
                        <div class="property-view">
                            ...
                            if( $property_layout == 'tabs' ) {
                                ...
                                get_template_part( 'property-details/single-project', 'simple');
                            }
...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/lib/js/Chart.min.js" id="chart-js"></script>