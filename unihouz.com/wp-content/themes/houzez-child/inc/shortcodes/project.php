<?php function insert_project_shortcode_cs( $args, $content ) { ?>	
								...
								<div class="item-header">
									<div class="labels-wrap labels-right">
										<?php if (get_field('project_label')) { ?>
											<div class="hz-label">
												<a href="https://unihouz.gcosoftware.vn/nhan/gia-tot/" class="label label-color-61"><?php echo get_field('project_label'); ?></a>
											</div>
										<?php } ?>
									...
									<ul class="item-amenities item-amenities-with-icons">
										<?php if (get_field('project_area')) { ?>
											<div class="custom-area">
												<img src="<?php echo get_stylesheet_directory_uri(); ?>/lib/images/area.png">
												<span class="area-label"> <?php esc_html_e('Diện tích :', 'houzez') ?> </span>
											</div>
											<li class="h-area">
												<span class="hz-figure"><?php echo get_field('project_area'); ?> </span>
											</li>
										<?php } ?>
										...
										<?php if (get_field('project_price')) { ?>
											<div class="custom-price">
												...
												<div class="price-item">
													<li class="item-price item-price-text"><?php echo get_field('project_price'); ?></li>
												</div>
											</div>
										<?php } else { ?>
											<div class="custom-price">
												...
												<div class="price-item">
													<li class="item-price item-price-text"><?php esc_html_e('Đang cập nhật', 'houzez') ?></li>
												</div>
											</div>
										<?php } ?>
									</ul> 
...
add_shortcode( 'project_shortcode_cs', 'insert_project_shortcode_cs' );
?>