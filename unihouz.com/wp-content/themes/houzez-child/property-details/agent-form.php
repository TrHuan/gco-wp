		...
		<div class="property-form clearfix">
			<form method="post" action="#">
				...
				<div class="form-group form-group-textarea">
					<textarea class="form-control hz-form-message" name="message" rows="4" placeholder="<?php echo houzez_option('spl_con_message', 'Message'); ?>"><?php echo houzez_option('spl_con__interested', "Xin chào! Tôi quan tâm"); ?> [<?php echo get_the_title(); ?>]</textarea>
				</div><!-- form-group -->	
				<?php //} ?>
				...
				<button type="button" class="houzez_agent_property_form btn btn-secondary <?php echo esc_attr($send_btn_class); ?>">
					...
					<?php echo houzez_option('spl_btn__send', 'Gửi email'); ?>
				...
				<a href="tel:<?php echo esc_attr($agent_mobile_call); ?>" class="btn btn-secondary-outlined btn-half-width">
					<!-- <button type="button" class="btn"> -->
						<span class="hide-on-click"><?php echo houzez_option('spl_btn__call', 'Gọi điện'); ?></span>
