<?php
$agency_facebook = get_field('investor_facebook');
$agency_twitter = get_field('investor_twitter');
$agency_linkedin = get_field('investor_linkedin');
$agency_googleplus = get_field('investor_address');
$agency_youtube = get_field('investor_youtube');
$agency_pinterest = get_field('investor_pinterest');
$agency_instagram = get_field('investor_instagram');
$agency_vimeo = get_field('investor_vimeo');
$agency_mobile = get_field('investor_mobile');
$agency_whatsapp = get_field('investor_whatsapp');
