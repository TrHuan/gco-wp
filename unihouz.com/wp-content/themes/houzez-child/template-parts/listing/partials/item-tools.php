...
<ul class="item-tools">
    ...
    <li class="item-tool item-preview">
        <span class="hz-show-lightbox-js" data-listid="<?php echo intval($post->ID)?>" data-toggle="tooltip" data-placement="top" title="<?php echo houzez_option('cl__preview', 'Xem trước'); ?>">
