...
<div id="compare-property-panel" class="compare-property-panel compare-property-panel-vertical compare-property-panel-right">
	...
	<p><strong><?php echo esc_html__('Hạng mục so sánh', 'houzez'); ?></strong></p>
	...
	<button class="btn btn-grey-outlined btn-full-width close-compare-panel"><?php echo esc_html__('Đóng', 'houzez'); ?></button>
</div>