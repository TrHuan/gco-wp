	...
	<div class="<?php echo houzez_header_search_width(); ?>">
		<form class="houzez-search-form-js <?php houzez_search_filters_class(); ?>" method="get" autocomplete="off" action="<?php echo esc_url( houzez_get_search_template_link() ); ?>">
			...
			<div class="d-flex">
				...
				<button type="submit" class="btn btn-search btn-secondary <?php if( houzez_is_half_map() ) { echo 'half-map-search-js-btn'; }?>"><?php esc_html_e('Tìm kiếm dự án', 'houzez'); ?>  &nbsp; <img src="<?php echo get_stylesheet_directory_uri(); ?>/lib/images/search.png" alt="search"> </button>		
			</div><!-- d-flex -->
