...
$section_title = isset($ele_settings['section_title']) && !empty($ele_settings['section_title']) ? $ele_settings['section_title'] : esc_html__('Để lại đánh giá', 'houzez');
...
<div class="property-review-wrap property-section-wrap" id="property-review-wrap">
	<div class="block-title-wrap review-title-wrap d-flex align-items-center">
		...
		<a class="btn btn-primary btn-slim" href="#property-review-form"><?php esc_html_e('Để lại đánh giá', 'houzez'); ?></a>
	</div>
