    ...
    <div class="d-flex justify-content-end">
        ...
        <?php } ?>
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img width="20" height="20" alt="author"  src="<?php echo get_stylesheet_directory_uri(); ?>/lib/images/user.png" class="rounded">
            </a>
            ...
            <?php if( $create_lisiting_enable != 0 || !empty(houzez_option('hd1_4_phone'))){ ?>
                <div class="login-register-nav">
                    ...
                    <a class="btn btn-create-listing hidden-xs hidden-sm" href="<?php echo esc_url($dashboard_add_listing); ?>">
                        <img width="15" height="20" alt="author"  src="<?php echo get_stylesheet_directory_uri(); ?>/lib/images/pen.png" class="">
