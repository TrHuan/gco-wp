...
<div class="col-lg-3 col-md-6 col-sm-6">
    <article class="ap-slider-item sale-item">
        <figure class="text-center ap-item-img">
        ...
        <figcaption class="pt-2 ap-item-content sale-item-info">
            <h4 class="t4">
                <?php
            ...
            <h3 class="s15 text-capitalize ap-item-stit sale-item-tit">
