	...
	<div class="row">
		<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="order_review_1">
				...
				<h3 id="order_review_heading"><?php esc_html_e( 'Phương thức thanh toán', 'woocommerce' ); ?></h3>
		...
		<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="order_review_2">
				<h3 id="order_review_heading"><?php esc_html_e( 'Thông tin đơn hàng', 'woocommerce' ); ?></h3>
				...
				<div class="form-row place-order">
					...
					<div class="pb-2 cart-link"><a href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) ); ?>" title=""><i class="fas fa-chevron-left mr-3"></i> <?php echo __('Tiếp tục mua hàng'); ?></a></div>
