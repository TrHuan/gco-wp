...
function lth_plugin_activation() {
        ...
        $plugins = array(
                ...
                array(
                        ...
                        'name'               => 'Slidershow', // The plugin name

                        'slug'               => 'slidershow', // The plugin slug (typically the folder name)

                        'source'             => get_template_directory() . '/inc/plugins/slidershow.zip', // The plugin source
                ...
                array(
                        ...
                        'slug'               => 'features', // The plugin slug (typically the folder name)

                        'source'             => get_template_directory() . '/inc/plugins/features.zip', // The plugin source
                ...
                array(
                        ...
                        'name'               => 'Brands', // The plugin name

                        'slug'               => 'brands', // The plugin slug (typically the folder name)

                        'source'             => get_template_directory() . '/inc/plugins/brands.zip', // The plugin source
                ...
                array(
                        ...
                        'slug'               => 'projects', // The plugin slug (typically the folder name)

                        'source'             => get_template_directory() . '/inc/plugins/projects.zip', // The plugin source
                ...
                array(
                        ...
                        'name'               => 'Services', // The plugin name

                        'slug'               => 'services', // The plugin slug (typically the folder name)

                        'source'             => get_template_directory() . '/inc/plugins/services.zip', // The plugin source
