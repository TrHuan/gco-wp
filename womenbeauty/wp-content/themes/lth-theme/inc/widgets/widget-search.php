  ...
  class Widget_Search extends WP_Widget {
    ...
    */
    ...
    function widget( $args, $instance ) { 
      ...
      <div class="newsletter-box blog-details-box">
        <form action="#">
            <input type="text" name="search" placeholder="<?php echo __('Từ khóa'); ?>" class="subscribe">
            <button class="submit"><?php echo __('Tìm'); ?></button>
