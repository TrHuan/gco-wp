...
<div  class="tab-countdown-slide clearfix">	
		...
		<div class="top-tab-slider clearfix">	
			<div id="<?php echo 'tab_' . $countdown_id; ?>" class="sw-tab-slider responsive-slider loading hidden-sm hidden-xs" data-lg="4" data-md="4" data-sm="3" data-xs="3" data-mobile="3" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-autoplay="false" data-vertical="true">
		...
		<div class="top-tab-slider-full clearfix">	
			<div id="<?php echo 'tab_' . $countdown_id2; ?>" class="sw-tab-slider2 responsive-slider loading hidden-lg hidden-md" data-lg="3" data-md="3" data-sm="4" data-xs="5" data-mobile="2" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-autoplay="false" data-vertical="false">
				<ul class="nav nav-tabs slider responsive">
					<?php
						$i = 0;
						while($list->have_posts()): $list->the_post();	
