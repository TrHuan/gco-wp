	...
	class sw_woo_slider_countdown_widget extends WP_Widget {
			  ...
			  "params" => array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array('Layout Default' => 'default','Layout Tab Countdown' => 'layout3','Layout Tab Countdown 2' => 'layout2', 'Layout Countdown Mobile' => 'layout4' ),
		...
		**/
		function WS_Shortcode_Countdown( $atts, $content = null ){
			...
			elseif ($layout == 'layout2') {
				include( sw_override_check( 'sw-countdown-slider', 'tab-countdownt-2' ) );	
			}
		...
		**/
		...
		function update( $new_instance, $old_instance ) {
			...
			if ( array_key_exists('style_title', $new_instance) ){
		...
		public function form( $instance ) {
			...
			$style_title    		   = isset( $instance['style_title'] )     	? strip_tags($instance['style_title']) : 'style1';
			...
			$title_length     		= isset( $instance['title_length'] )      	? intval($instance['title_length']) : 25;
			...
			<p>
				<label for="<?php echo $this->get_field_id('style_title'); ?>"><?php _e('Style Title', 'sw_woocommerce')?></label>
				<br />
				<select class="widefat"
					id="<?php echo $this->get_field_id('style_title'); ?>" name="<?php echo $this->get_field_name('style_title'); ?>">
					<option value="title1" <?php if ($style=='style1'){?> selected="selected"
					<?php } ?>>
						<?php _e('Style 1', 'sw_woocommerce')?>
					</option>
					<option value="title2" <?php if ($order=='style2'){?> selected="selected"	<?php } ?>>
						<?php _e('Style 2', 'sw_woocommerce')?>
					</option>
					<option value="title3" <?php if ($order=='style3'){?> selected="selected"	<?php } ?>>
						<?php _e('Style 3', 'sw_woocommerce')?>
					</option>
					<option value="title4" <?php if ($order=='style4'){?> selected="selected"	<?php } ?>>
						<?php _e('Style 4', 'sw_woocommerce')?>
					</option>
				</select>
			</p>
			<p>
			...
			<p>
				<label for="<?php echo $this->get_field_id('product_select'); ?>"><?php _e('Product Select', 'sw_woocommerce')?></label>
				<br />
				<select class="widefat"
			...
			<p>
				<label for="<?php echo $this->get_field_id('title_length'); ?>"><?php _e('Title length (in words): ', 'sw_woocommerce')?></label>
				<br />
				<input class="widefat"
					id="<?php echo $this->get_field_id('title_length'); ?>" name="<?php echo $this->get_field_name('title_length'); ?>" type="text" 
			...
			<p>
				...
				<select class="widefat"
					...
					<option value="tab-countdownt-2" <?php if ($widget_template=='tab-countdownt-2'){?> selected="selected"
					<?php } ?>>
						<?php _e('Layout Tab Countdown2', 'sw_woocommerce')?>		
					</option>			
					<option value="countdown-mobile" <?php if ($widget_template=='countdown-mobile'){?> selected="selected"
					<?php } ?>>
						<?php _e('Layout Countdown Mobile', 'sw_woocommerce')?>
					</option>
				</select>
			</p>  
		<?php
