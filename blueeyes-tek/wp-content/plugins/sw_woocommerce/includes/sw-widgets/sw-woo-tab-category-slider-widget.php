	...
	class sw_woo_tab_cat_slider_widget extends WP_Widget {
		...
		function __construct() {
			...
			if( version_compare( WC()->version, '2.4', '>=' ) ){
					...
					add_action( 'wc_ajax_sw_ajax_tab_listing', array( $this, 'sw_ajax_tab_listing' ) );
			}else{
				...
				/* Ajax Tab Listing Call */
				add_action( 'wp_ajax_sw_ajax_tab_listing', array( $this, 'sw_ajax_tab_listing') );
				add_action( 'wp_ajax_nopriv_sw_ajax_tab_listing', array( $this, 'sw_ajax_tab_listing') );
			}
		}
			  ...
			  "params" => array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Tab Ajax Listing' => 'layout1' ),
