	...
	class sw_woo_tab_slider_widget extends WP_Widget {
		...
		function SC_integrateWithVC(){
			...
			vc_map( array(
				...
				array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => 'default', 'Layout 1' => 'layout1', 'Layout Mobile'=>'layout3' ),
		...
		**/
		...
		function sw_tab_category_callback(){
			...
			if( $list->have_posts() ) :
				if( $layout == 'layout1' || $layout == 'theme1' ) : 
		?>
		...
		function update( $new_instance, $old_instance ) {
			...
			$instance['banner_links'] = strip_tags( $new_instance['banner_links'] );
			// int or array
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo $this->get_field_id('banner_links'); ?>"><?php _e('Banner_links', 'sw_woocommerce')?></label>
				<br />
