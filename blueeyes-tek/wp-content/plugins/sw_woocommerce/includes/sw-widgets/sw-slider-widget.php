			  ...
			  "params" => array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => 'default', 'Layout Featured' => 'featured', 'Layout Best Sales' => 'bestsales', 'Layout Best Sales Mobile' => 'bestsales-mobile' ),
		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat"
					...
					<option value="bestsales-mobile" <?php if ($widget_template=='bestsales-mobile'){?> selected="selected"
					<?php } ?>>
						<?php _e('Best Sales Mobile', 'sw_woocommerce')?>
					</option>
				</select>
			</p>  
		<?php
