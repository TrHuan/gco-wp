				...
				array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Category Ajax' => 'layout1', 'Layout Mobile' => 'layout3',  'Layout Mobile2' => 'theme4', 'Layout Mobile Ajax' => 'layout4' ),
		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat"
					...
					<?php } ?>>
						<?php _e('Layout Category Ajax', 'sw_woocommerce')?>
					</option>
					...
					<?php } ?>>
						<?php _e('Layout Mobile2', 'sw_woocommerce')?>		
					</option>
					<option value="category_mobile_ajax" <?php if ($widget_template=='category_mobile_ajax'){?> selected="selected"
					<?php } ?>>
						<?php _e('Layout Mobile Ajax', 'sw_woocommerce')?>		
					</option>				
				</select>
			</p>  
		<?php
