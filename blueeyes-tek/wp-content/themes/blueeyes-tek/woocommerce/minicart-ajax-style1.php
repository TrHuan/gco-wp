	...
	<div class="product-details-bottom">
		 ...
		 <span class="price"><?php echo $woocommerce->cart->get_product_subtotal($cart_item['data'], 1); ?></span>		        		        		    		
			...
			<div class="cart-checkout">
				...
				<div class="cart-link"><a href="<?php echo wc_get_cart_url(); ?>" title="Cart"><?php esc_html_e('Giỏ hàng', 'maxshop'); ?></a></div>
				<div class="checkout-link"><a href="<?php echo wc_get_checkout_url(); ?>" title="Check Out"><?php esc_html_e('Thanh toán', 'maxshop'); ?></a></div>
			</div>
		</div>
	</div>
	<?php } ?>
