...
<div class="ya-comments">
	...
	<div class="ya-comment">
		...
		<div class="comment-author">
			<span><?php esc_html_e('Written by', 'maxshop');?></span>: <a href="<?php echo get_comment_author_link( $comment->comment_ID ); ?>"><?php echo get_comment_author( $comment->comment_ID );?></a>
		</div>
	</div>
	<?php } ?>
</div>
