...
<p>
	<label for="<?php echo $this->get_field_id('categories'); ?>"><?php esc_html_e('Categories Name', 'maxshop')?></label>
	<br />
...
<p>
	<label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e('Number of Categories', 'maxshop')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo $this->get_field_id('exclude'); ?>"><?php esc_html_e('Exclude', 'maxshop')?></label>
	<br />
	<input class="widefat"
