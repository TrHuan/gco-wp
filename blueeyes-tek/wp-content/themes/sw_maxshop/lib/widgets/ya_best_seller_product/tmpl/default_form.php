...
<p>
			<label for="<?php echo $this->get_field_id('el_class'); ?>"><?php esc_html_e('El_class', 'maxshop')?></label>
			<br />
...
<p>
			<label for="<?php echo $this->get_field_id('style_title'); ?>"><?php esc_html_e('Style title ', 'maxshop')?></label>
			<br />
