...
<p>
	<label for="<?php echo $this->get_field_id('showposts'); ?>"><?php esc_html_e('Number of Posts', 'maxshop')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo $this->get_field_id('length'); ?>"><?php esc_html_e('Length of excerpt', 'maxshop')?></label>
	<br />
	<input class="widefat"
