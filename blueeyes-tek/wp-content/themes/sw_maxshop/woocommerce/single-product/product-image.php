...
$ya_single_thunbmail = ( ya_options()->getCpanelValue( 'product_single_thumbnail' ) && !ya_mobile_check() ) ? ya_options()->getCpanelValue( 'product_single_thumbnail' ) : 'bottom';
$post_thumbnail_id	 = get_post_thumbnail_id( $post->ID );
?>
<div id="product_img_<?php echo esc_attr( $post->ID ); ?>" class="woocommerce-product-gallery woocommerce-product-gallery--with-images images product-images loading"  data-vertical="<?php echo ( ( $ya_single_thunbmail == 'left' || $ya_single_thunbmail == 'right' ) && !ya_mobile_check() ) ? 'true' : 'false'; ?>" data-video="<?php echo ( $ya_featured_video != '' ) ?  esc_url( 'https://www.youtube.com/embed/' . $ya_featured_video ) : ''; ?>">
	<figure class="woocommerce-product-gallery__wrapper">
	<div class="product-images-container clearfix <?php echo esc_attr( 'thumbnail-' . $ya_single_thunbmail ); ?>"">
		<?php 
