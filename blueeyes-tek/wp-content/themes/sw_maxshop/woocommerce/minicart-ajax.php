...
<div class="top-form top-form-minicart minicart-product-style1 pull-right">
	<div class="top-minicart pull-right">
		...
		<span><?php esc_html_e('Giỏ hàng','maxshop');?></span>
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'maxshop'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'?></a>
