...
<div class="top-form top-form-minicart  minicart-product-style2 pull-right">
	...
	<h2><?php esc_html_e('Shopping Cart','maxshop');?></h2>
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'maxshop'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'; esc_html_e('item(s)', 'maxshop');?> - <?php echo $woocommerce->cart->get_cart_subtotal(); ?></a>
    ...
    <div class="product-details"> 
        ...
        <a class="btn-edit" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'maxshop'); ?>"><span></span></a>    
		 ...
		 <span class="price"><?php echo $woocommerce->cart->get_product_subtotal($cart_item['data'], 1); ?></span>		        		        		    		
			...
			<div class="cart-checkout">
			    <div class="price-total">
				   <span class="label-price-total"><?php esc_html_e('Tổng:', 'maxshop'); ?></span>
				   <span class="price-total-w"><span class="price"><?php echo $woocommerce->cart->get_cart_subtotal(); ?></span></span>
				   
				</div>
				<div class="cart-link"><a href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>" title="Cart"><?php esc_html_e('Giỏ hàng', 'maxshop'); ?></a></div>
				<div class="checkout-link"><a href="<?php echo get_permalink(get_option('woocommerce_checkout_page_id')); ?>" title="Check Out"><?php esc_html_e('Thanh toán', 'maxshop'); ?></a></div>
			</div>
		</div>
	</div>
	<?php } ?>
