		...
		<div class="entry clearfix">
			...
			<div class="entry-content">				
             ...
             <div class="entry-meta">
                    <div class="bl_read_more"><a href="<?php the_permalink(); ?>"><i class="fa fa-chevron-right"></i><?php esc_html_e('Read more','maxshop')?></a></div>			 
						...
						<?php if( $format == 'gallery' ) { 
							...
							<div class="entry-thumb">
								<div id="gallery_slider_<?php echo $post->ID; ?>" class="carousel slide gallery-slider" data-interval="0">	
									...
									<a href="#gallery_slider_<?php echo $post->ID; ?>" class="left carousel-control" data-slide="prev"><?php esc_html_e( 'Prev', 'maxshop' ) ?></a>
									<a href="#gallery_slider_<?php echo $post->ID; ?>" class="right carousel-control" data-slide="next"><?php esc_html_e( 'Next', 'maxshop' ) ?></a>
								</div>
							</div>
							<?php }	?>							
						<?php } ?>
