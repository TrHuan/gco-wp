...
if ( !is_admin() && $GLOBALS['pagenow'] !== 'wp-login.php' ) {
    ...
    function show_value_to_destop() {
        ...
        $socical_zalo        = get_option('option_zalo');
    ...
    <div id="tool__society">
        <div class="tool__item">
            ...
            <a href="tel:<?php echo $socical_phone; ?>" class="tool__icon tool__icon_tel" title="">
                <img src="<?php echo plugin_dir_url( __FILE__ ).'dist/images/icon/icon-phone.png'; ?>" alt="phone" width="33" height="33">
            </a>
            <?php } ?>

            <?php if(!empty( $socical_zalo )) { ?>
            <a href="https://zalo.me/<?php echo $socical_zalo; ?>" class="tool__icon tool__icon_zalo" title="" target="_blank">
                <img src="<?php echo plugin_dir_url( __FILE__ ).'dist/images/icon/icon-zalo.png'; ?>" alt="zalo" width="33" height="33">
            </a>
            <?php } ?>

            <?php if(!empty( $socical_messenger )) { ?>
            <a href="https://facebook.com/<?php echo $socical_messenger; ?>" class="tool__icon tool__icon_mes" title="" target="_blank">
                <img src="<?php echo plugin_dir_url( __FILE__ ).'dist/images/icon/icon-mes.png'; ?>" alt="messenger" width="33" height="33">
            </a>
            <?php } ?>

            <?php if($socical_backtop == 'on') { ?>
            <a href="javascript:void(0)" id="back-to-top" class="tool__icon tool__icon_back" title="">
                <img src="<?php echo plugin_dir_url( __FILE__ ).'dist/images/icon/icon-back.png'; ?>" alt="back to top" width="33" height="33">
            </a>
            <?php } ?>
