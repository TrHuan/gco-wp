			...
			<tr class="cart-subtotal">
				<td colspan="2">
					...
					<div class="form-row place-order">
						...
						<button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="<?php echo __('Đặt hàng') ?>"><?php echo __('Đặt hàng') ?> <span><?php echo __('(Xem hàng, không mua không sao)'); ?></span></button>
...
<div class="module module__header">
	<a href="<?php echo HOME_URI; ?>" title="" class="btn-backs__buys"><?php echo __('&lt; Tiếp tục mua hàng'); ?></a>
</div>
