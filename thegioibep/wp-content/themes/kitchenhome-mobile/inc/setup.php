...
function lth_theme_setup() {
    ...
    function my_wp_nav_menu_objects( $items, $args ) { 
        foreach( $items as $item ) {
            ...
            if( $img ) {                
                $item->title .= '<img src="'.$img.'" width="60" height="45">';                
            }
        }      
        return $items;        
    }
...
function lth_sidebar_register() {
    ...
    register_sidebar (
        array (
            ...
            'before_widget' => '<div class="widget-html-box">',
            'after_widget' => '</div>',
            'before_title' => '<h3>',
            'after_title' => '</h3>',
        )
    ...
    register_sidebar (
        array (
            'name' => __('Footer Slogan'),
            'id'        => 'widget_footer_slogan',
            'before_widget' => '<div class="module_title footer-title">',
            'after_widget' => '</div>',
            'before_title' => '<h2>',
            'after_title' => '</h2>',
        )
    ...
    register_sidebar (
        array (
            'name' => __('Footer Mobile'),
            'id'        => 'widget_footer_mobile',
            'before_widget' => '<div class="footer-box">',
            'after_widget' => '</div>',
            'before_title' => '<h2>',
            'after_title' => '</h2>',
    ...
    if ( wp_is_mobile() ) {
        register_sidebar (
            array (
                'name' => __('Showroom'),
                'id'        => 'widget_showroom',
                'before_widget' => '<div class="showroom-box">',
                'after_widget' => '</div>',
                'before_title' => '<h2> <img src="'.ASSETS_URI.'/images/icon-27.png" alt="Icon">',
                'after_title' => '</h2>',
            )
        );
    } else {
        register_sidebar (
            array (
                ...
                'before_widget' => '<div class="showroom-box">',
                'after_widget' => '</div>',
                'before_title' => '<h2> <img src="'.ASSETS_URI.'/desktop/images/icon-27.png" alt="Icon">',
                'after_title' => '</h2>',
            )
        );
    }    
    ...
    register_sidebar (
        array (
            'name' => __('Điều khoản sử dụng'),
            'id'        => 'widget_terms_of_use',
    ...
    if ( class_exists( 'WooCommerce' ) ) {
        register_sidebar (
            array (
                'name' => __('Sản Phẩm'),
                'id'        => 'sidebar_shop',
                'before_widget' => '<div class="sidebar-box sidebar-products">',
                'after_widget' => '</div>',
                'before_title' => '<h3>',
                'after_title' => '</h3>',
            )
