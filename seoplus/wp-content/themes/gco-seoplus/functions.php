...
wp_enqueue_style( 'css-styles', get_stylesheet_uri(), array(), filemtime( get_theme_file_path( 'style.css' ) ) );


function global_post_ids() {
        global $featured_post_ids;
}
add_action( 'after_setup_theme', 'global_post_ids' );