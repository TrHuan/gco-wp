						...
						<div class="content-box">
							<ul>
								...
								<?php while( have_rows('content') ): the_row(); ?>
									...
									<li>
										<a class="<?php if($i == '1') {echo 'first active';} ?>" href="<?php if ($url) { echo $url; } else {echo 'javascript:0';} ?>"><?php echo $item; ?></a>
									</li>
				    			<?php endwhile; ?>
							</ul>

							<!-- <a href="#" title="Bình luận" class="btn reviews-box btn-popup" data_popup="popup-box-2">
		                        <span>Bình luận</span>
