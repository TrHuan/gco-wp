...
function lth_bank_details( $order_id = '' ) {
    ...
    if ( ! empty( $bacs_accounts ) ) {
        ...
        ?>
        <tr>
            <td colspan="2" style="border: 1px solid #ebebeb;padding: 6px 10px;">
                <strong><?php echo __('Thông tin chuyển khoản'); ?></strong>
            </td>
        </tr>
        <?php
        foreach ( $bacs_accounts as $bacs_account ) {
            ...
            <tr>
                ...
                <td style="border: 1px solid #ebebeb;padding: 6px 10px;">
                    <strong>STK:</strong> <?php echo $stk;?><br>
                    <strong>Chủ tài khoản:</strong> <?php echo $account_name;?><br>
                    <strong>Ngân hàng:</strong> <?php echo $bank_name;?>
                </td>
            </tr>
            <?php
        }
