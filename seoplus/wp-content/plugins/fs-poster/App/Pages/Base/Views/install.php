...
<div class="fsp-box-container">
	<div class="fsp-card fsp-box">
		...
		<div class="fsp-form-group">
			<input type="text" value="chowordpress.com" autocomplete="off" id="fspPurchaseKey" class="fsp-form-input" placeholder="<?php echo fsp__( 'Please Enter chowordpress.com' ); ?>">
		</div>
		<div class="fsp-form-group">
			<input type="email" value="chowordpress@gmail.com" autocomplete="off" id="fspEmail" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter your e-mail address (optional)' ); ?>">
		</div>
		<div class="fsp-form-group">
