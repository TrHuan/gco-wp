<div class="betterdocs-admin-analytics-wrapper">
    <div class="betterdocs-settings-header">
        <div class="betterdocs-header-left">
            <div class="betterdocs-admin-logo-inline">
...
<g>
	<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="393.6491" y1="85.0984" x2="80.0352" y2="539.4365">
	...
	<path class="st0" d="M365.6,179.4c-18.3,0-33.1-14.8-33.1-33.1V90.8H115.2c-14.1,0-25.5,11.4-25.5,25.5v58H65.9
		...
		V179.4l0,0H365.6z"/>
	<g>
		<linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="29.856" y1="170.1737" x2="9.9681" y2="203.9146">
			<stop  offset="0" style="stop-color:#68FF61"/>
			<stop  offset="1" style="stop-color:#01BAB4"/>
		</linearGradient>
	...
	<linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="119.0153" y1="152.89" x2="24.4316" y2="313.3562">
		<stop  offset="0" style="stop-color:#68FF61"/>
		<stop  offset="1" style="stop-color:#01BAB4"/>
	</linearGradient>
	...
	<linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="376.8101" y1="133.1894" x2="406.5692" y2="99.9105">
		<stop  offset="0" style="stop-color:#68FF61"/>
		<stop  offset="1" style="stop-color:#01BAB4"/>
	</linearGradient>
	...
	<g>
		<linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="431.9656" y1="96.2573" x2="460.3407" y2="60.0546">
			<stop  offset="0" style="stop-color:#68FF61"/>
			<stop  offset="1" style="stop-color:#01BAB4"/>
		</linearGradient>
	...
	<g>
		<linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="308.6317" y1="406.1334" x2="358.0752" y2="497.3481">
		...
		<linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="228.2928" y1="388.3171" x2="278.7111" y2="479.8327">
	...
	<linearGradient id="SVGID_8_" gradientUnits="userSpaceOnUse" x1="210.8642" y1="91.3904" x2="244.5006" y2="179.8417">
	...
	<linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="126.5509" y1="89.6049" x2="178.619" y2="184.1152">
		<stop  offset="0" style="stop-color:#7DF777"/>
		<stop  offset="1" style="stop-color:#45E87D;stop-opacity:0"/>
	</linearGradient>
	...
	<g>
		...
		<g>
			<g>
				<linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="362.3983" y1="331.0661" x2="450.6764" y2="275.403">
					<stop  offset="0" style="stop-color:#68FF61"/>
					<stop  offset="1" style="stop-color:#01BAB4"/>
				</linearGradient>
			...
			<linearGradient id="SVGID_11_" gradientUnits="userSpaceOnUse" x1="348.6286" y1="345.5825" x2="370.0806" y2="331.7425">
				<stop  offset="0" style="stop-color:#68FF61"/>
				<stop  offset="1" style="stop-color:#01BAB4"/>
			</linearGradient>
	...
	<path class="st20" d="M329.9,360.8h-72c-4,0-7.2-3.2-7.2-7.2l0,0c0-4,3.2-7.2,7.2-7.2h83L329.9,360.8z"/>
            ...
            <h2 class="title">BetterDocs Analytics</h2>
        </div>
        <div class="betterdocs-header-right">
            <span><?php _e( 'Version', 'notificationx' ); ?>: <strong><?php echo BETTERDOCS_VERSION; ?></strong></span>
            <?php if( defined('BETTERDOCS_PRO_VERSION') ) : ?>
                <span><?php _e( 'Pro Version', 'notificationx' ); ?>: <strong><?php echo BETTERDOCS_PRO_VERSION; ?></strong> </span>
            <?php endif; ?>
        </div>
    </div>

    <?php do_action( 'betterdocs_after_analytics_header' ); ?>

    <div class="betterdocs-analytics-menu">
        <form action="<?php echo admin_url( 'admin.php?page=betterdocs-analytics' ); ?>" method="GET" class="betterdocs-analytics-form" id="betterdocs-analytics-form">
            <?php wp_nonce_field( '_betterdocs_analytics_nonce' ); ?>
            <div class="betterdocs-analytics-form-field betterdocs_docs">
                <label for="betterdocs_docs"><?php _e( 'Select Docs', 'betterdocs-pro' ); ?></label>
                <select id="betterdocs_docs" multiple="multiple" name="betterdocs[]">
                    <?php 
                        $selected_betterdocs = [ 'all' ];
                        $selected = '';
                        $selected_all = false;
                        if( isset( $_GET['betterdocs'] ) && ! empty( $_GET['betterdocs'] ) ) {
                            $selected_betterdocs = explode(',', $_GET['betterdocs']);
                        }
                        if( in_array( 'all', $selected_betterdocs ) ) {
                            $selected = 'selected="true"';
                            $selected_all = true;
                        }
                    ?>
                    <option <?php echo $selected; ?> value="all"><?php _e('All', 'betterdocs-pro'); ?></option>
                    <?php 
                        if( ! empty( self::$betterdocs ) ) {
                            $selected = '';
                            foreach( self::$betterdocs as $betterdocs ) {
                                if( in_array( $betterdocs->ID, $selected_betterdocs ) ) {
                                    $selected = 'selected="true"';
                                    if( $selected_all ) {
                                        $selected = '';
                                    }
            ...
            <div class="betterdocs-analytics-form-field">
                <label for="betterdocs_start_date"><?php _e( 'Start Date', 'betterdocs-pro' ); ?></label>
                <input id="betterdocs_start_date" placeholder="<?php _e( 'Start Date', 'betterdocs-pro' ); ?>" type="text" name="start_date">
            </div>
            <div class="betterdocs-analytics-form-field">
                <label for="betterdocs_end_date"><?php _e( 'End Date', 'betterdocs-pro' ); ?></label>
                <input id="betterdocs_end_date" placeholder="<?php _e( 'End Date', 'betterdocs-pro' ); ?>" type="text" name="end_date">
            </div>
            <div class="betterdocs-analytics-form-field betterdocs_comparison_factor">
                <label for="betterdocs_comparison_factor"><?php _e( 'Comparison Factor', 'betterdocs-pro' ); ?></label>
                <select id="betterdocs_comparison_factor"  multiple="multiple" name="comparison_factor[]">
                    <?php 
                        $comparison_factors = [ 'views', 'feelings' ];
                        $selected = '';
            ...
            <input id="betterdocs_analytics_submit" class="betterdocs-analytics-button" type="submit" value="<?php _e('Submit', 'betterdocs-pro'); ?>">
        </form>
    </div>
    <div class="betterdocs-canvas-area">
        <canvas id="betterdocs_canvas"></canvas>
    </div>
    <div class="betterdocs-search-display">
        <div class="popular-search-box">
            <?php
            $keywords = array();
            $get_search_keyword = get_option( 'betterdocs_search_data' );
            //var_dump($get_search_keyword);
            if ($get_search_keyword) {
                $search_keyword_arr = unserialize($get_search_keyword);
                arsort($search_keyword_arr);
                $popular_keyword_arr = array_slice($search_keyword_arr, 0, 10, true);
                //var_dump($search_keyword_arr);
        ...
        <div class="no-results-search-box">
            <?php
            $keywords = array();
            $get_search_not_found = get_option( 'betterdocs_search_not_found' );
            //var_dump($get_search_keyword);
            if ($get_search_not_found) {
                $search_not_found_arr = unserialize($get_search_not_found);
                arsort($search_not_found_arr);
                $search_not_found_arr = array_slice($search_not_found_arr, 0, 10, true);
                //var_dump($search_not_found_arr);
                if ( $search_not_found_arr ) {
                    foreach ($search_not_found_arr as $key=>$value) {
                        //if ($value > 5) {
                        array_push($keywords, $key);
                        //}
                    }
