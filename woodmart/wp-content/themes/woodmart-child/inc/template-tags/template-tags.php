...
if ( ! function_exists( 'woodmart_read_more_tag' ) ) {
	function woodmart_read_more_tag() {
		return '<a class="btn-read-more more-link" href="' . get_permalink() . '">' . esc_html__( 'Xem tiếp', 'woodmart' ) . '</a>';
	}
}
					...
					<?php if ( $author == 1 ) : ?>
						<li class="meta-author">
							<?php if ( $labels == 1 && ! $short_labels ) : ?>
								<?php esc_html_e( 'Đăng bởi', 'woodmart' ); ?>
						...
						<?php if ( ! empty( $next_post ) ) : ?>
							<div class="posts-nav-inner">
								<a href="<?php echo get_permalink( $next_post->ID ); ?>">
									<span class="btn-label"><?php esc_html_e( 'Tiếp theo', 'woodmart' ); ?></span>
						...
						<?php if ( ! empty( $prev_post ) ) : ?>
							<div class="posts-nav-inner">
								<a href="<?php echo get_permalink( $prev_post->ID ); ?>">
									<span class="btn-label"><?php esc_html_e( 'Trở lại', 'woodmart' ); ?></span>
