...
<div class="col-lg-12 col-12 col-md-12">
    <div class="frequently_asked_questions">
        <h2 class="title"><?php echo __('Câu hỏi thường gặp'); ?></h2>
        <?php 
            $listques=get_field('listques','option');

            if ($listques) { ?>
                <ul>
                    <?php foreach( $listques as $item ) { ?>
                        <li>
                            <label><strong><?php echo $item['item_ques']; ?></strong></label>

                            <p><?php echo $item['item_ans']; ?></p>
                        </li>                        
                    <?php } ?>
                </ul>
            <?php }
        ?>
        <?php //do_action('listques'); ?>
    </div>
</div>
<?php 
    /**
