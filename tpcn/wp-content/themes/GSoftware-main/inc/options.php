...
Redux::setSection( $opt_name, array(
    'title'            => __( 'Banners', 'shtheme' ),
    'id'               => 'homepage-banners',
    'subsection'       => true,
    'fields'           => array(
        array(
            'id'         => 'home-banners-slide',
            'type'       => 'slides',
            'title'      => __('Banners', 'shtheme'),
            'show'       => array(
                'title' => false,
...
Redux::setSection( $opt_name, array(
    'title'            => __( 'Đặt hàng ngay', 'shtheme' ),
    'id'               => 'homepage-banner',
    'subsection'       => true,
    'fields'           => array(
        array(
            'id'         => 'home-banner',
            'type'       => 'media',
            'title'      => __('Image', 'shtheme'),
        ),
        array(
            'id'         => 'home-banner-text-top',
            'type'       => 'text',
            'title'      => __('Text top', 'shtheme'),
        ),
        array(
            'id'         => 'home-banner-text-bottom',
            'type'       => 'text',
            'title'      => __('Text bottom', 'shtheme'),
        ),
        array(
            'id'         => 'home-banner-url',
            'type'       => 'text',
            'title'      => __('Url', 'shtheme'),
        ),
    )
) );
...
Redux::setSection( $opt_name, array(
    'title'            => __( 'Features', 'shtheme' ),
    'id'               => 'homepage-features',
    'subsection'       => true,
    'fields'           => array(
        array(
            'id'         => 'home-features-slide',
            'type'       => 'slides',
            'title'      => __('Feature', 'shtheme'),
        ),
    )
) );        

Redux::setSection( $opt_name, array(
    'title'            => __( 'Khách hàng đánh giá', 'shtheme' ),
    'id'               => 'homepage-testimonials',
    'subsection'       => true,
    'fields'           => array(
        array(
            'id'         => 'home-testimonials-slide',
            'type'       => 'slides',
            'title'      => __('Đánh giá', 'shtheme'),
        ),
    )
) );   
...
Redux::setSection( $opt_name, array(
    'title'            => __( 'Đối tác', 'shtheme' ),
    'id'               => 'homepage-brands',
    'subsection'       => true,
    'fields'           => array(
        array(
            'id'         => 'home-brands-slide',
            'type'       => 'slides',
            'title'      => __('Đối tác', 'shtheme'),
            'show'       => array(
                'title' => false,
...
// -> GCO Developer
Redux::setSection( $opt_name, array(
    'title'            => __( 'GCO Developer', 'shtheme' ),
    'id'               => 'function',
