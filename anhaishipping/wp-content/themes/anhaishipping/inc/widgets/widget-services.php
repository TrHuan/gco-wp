<?php
  ...
  */
  ...
  add_action( 'widgets_init', 'create_widget_services' );

  function create_widget_services() {

    register_widget('Widget_Services');
  ...
  * Tạo class Widget_Services

  */

  class Widget_Services extends WP_Widget {
    ...
    */
    ...
    function __construct() {
      ...
      parent::__construct (
        ...
        'widget_services', // id của widget

        'Dịch Vụ', // tên của widget
    ...
    */
    ...
    function widget( $args, $instance ) { 
      ...
      echo '<div class="module module_services sidebar-services-box">';
      ...
      <div class="module_content">
          <?php if ($wp_query->have_posts()) { ?>
            ...
            <?php while ($wp_query->have_posts()) {
              ...
              get_template_part('template-parts/service/content', 'sidebar');
