<?php
  ...
  */
  ...
  add_action( 'widgets_init', 'create_widget_fleets' );

  function create_widget_fleets() {

    register_widget('Widget_Fleets');
  ...
  * Tạo class Widget_Fleets

  */

  class Widget_Fleets extends WP_Widget {
    ...
    */
    ...
    function __construct() {
      ...
      parent::__construct (
        ...
        'Widget_fleet', // id của widget

        'Đội Tàu', // tên của widget
    ...
    */
    ...
    function widget( $args, $instance ) { 
      ...
      echo '<div class="module module_fleets sidebar-fleets-box">';
          ...
          <?php if ($wp_query->have_posts()) { ?>
            ...
            <ul>
              ...
              <?php while ($wp_query->have_posts()) {
                ...
                get_template_part('template-parts/doi-tau/content', 'sidebar');
