<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Ảnh Banner page Posts', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Image you want as Banner.', 'redux-framework-demo' )
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Banner Slider', 'redux-framework-demo' ),
        'id'         => 'slider-banner',
        'desc'       => __( 'Options section banner on theme', 'redux-framework-demo' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'          => 'opt-slides-banner',
                'type'        => 'slides',
                'title'       => __( 'Slides Options banner', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Nội thất', 'redux-framework-demo' ),
        'id'         => 'section-furniture',
        'desc'       => __( 'Options section furniture on theme', 'redux-framework-demo' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'opt-title-furniture',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-des-furniture',
                'type'     => 'textarea',
                'title'    => __( 'Mô tả', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-select-furniture',
                'type'     => 'select',
                'data'     => 'categories',
                'title'    => __( 'Chuyên mục tin', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Kiến trúc', 'redux-framework-demo' ),
        'id'         => 'section-architecture',
        'desc'       => __( 'Options section architecture on theme', 'redux-framework-demo' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'opt-title-architecture',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-des-architecture',
                'type'     => 'textarea',
                'title'    => __( 'Mô tả', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-select-architecture',
                'type'     => 'select',
                'data'     => 'categories',
                'title'    => __( 'Chuyên mục tin', 'redux-framework-demo' ),
                'subtitle' => __( 'Select the category you want to display', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'         => 'section-blog',
        'desc'       => __( 'Options section blog on theme', 'redux-framework-demo' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'opt-title-blog',
            ...
            array(
                'id'       => 'opt-url-blog',
                'type'     => 'text',
                'title'    => __( 'Link xem tất cả', 'redux-framework-demo' ),
                'default'  => '',
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Videos', 'redux-framework-demo' ),
        'id'         => 'section-videos',
        'desc'       => __( 'Options section videos on theme', 'redux-framework-demo' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'opt-title-videos_newspapers',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'          => 'opt-slides-videos_newspapers',
                'type'        => 'slides',
                'title'       => __( 'Slides Options videos_newspapers', 'redux-framework-demo' ),
                'subtitle'    => __( 'Unlimited slides with drag and drop sortings.', 'redux-framework-demo' ),
                'desc'        => __( 'This field will store all slides values into a multidimensional array to use into a foreach loop.', 'redux-framework-demo' ),
                'placeholder' => array(
                    'title'       => __( 'This is a title', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'     => 'infor-contact',
        'desc'   => __( 'All of settings on this theme.', 'redux-framework-demo' ),
        'icon'   => 'el el-home',
        'fields' => array(
            array(
                'id'       => 'opt-title-infor_contact',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-description-infor_contact',
                'type'     => 'textarea',
                'title'    => __( 'Mô tả', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-address-infor_contact_1',
                'type'     => 'text',
                'title'    => __( 'Địa chỉ 1: ', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-address-infor_contact_2',
                'type'     => 'text',
                'title'    => __( 'Địa chỉ 2: ', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-hotline-infor_contact',
                'type'     => 'text',
                'title'    => __( 'Hotline: ', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-email-infor_contact',
                'type'     => 'text',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'        =>'opt-social-zalo',
                'type'      => 'text',
                'title'     => __('Link Zalo', 'redux-framework-demo'),
            ),
            array(
                'id'        =>'opt-social-messenger',
                'type'      => 'text',
                'title'     => __('Link Messenger', 'redux-framework-demo'),
            ),
        )
    ) );
    // -> Information
