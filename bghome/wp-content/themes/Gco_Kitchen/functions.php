...
add_action( 'woocommerce_after_single_product_summary', 'woocommerce_form_contact_after_tabs', 10 );
function woocommerce_form_contact_after_tabs() {
    echo do_shortcode('[contact-form-7 id="139" title="Form Liên hệ"]');
} 
...
{
    wp_enqueue_style('css-lth-slick', THEME_URI . '/css/slick.min.css', false, 'all');
}
...
{
      wp_enqueue_script('js-lth-slick', THEME_URI .'/js/slick.min.js', false, 'all');
}
