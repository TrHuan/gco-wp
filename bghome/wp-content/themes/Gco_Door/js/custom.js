...
jQuery(document).ready(function ($) {
  $('#homepage-wrapper .owl-carousel').owlCarousel({
    loop: true,
    nav: true,
...
jQuery(document).ready(function ($) {
  const data_timer = $('#timer_count_down').data("id");
  var timer;
  var compareDate = new Date();
  compareDate.setDate(compareDate.getDate() + data_timer); //just for this demo today + 7 days
