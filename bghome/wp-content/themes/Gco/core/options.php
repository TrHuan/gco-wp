<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'opt-banner-products',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Ảnh Banner page Product', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Image you want as Banner.', 'redux-framework-demo' )
            ),
            array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Ảnh Banner page Child', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Image you want as Banner.', 'redux-framework-demo' )
            ),
        )
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Đối tác', 'redux-framework-demo' ),
        'id'         => 'section-partner',
        'desc'       => __( 'Options section partner on theme', 'redux-framework-demo' ),
        'icon'   => 'el el-home',
        'fields'     => array(
            array(
                'id'       => 'opt-title-partner',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'          => 'opt-slides-partner',
                'type'        => 'slides',
                'title'       => __( 'Slides Options partner', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'       => __( 'Options section information on theme', 'redux-framework-demo' ),
        'icon'   => 'el el-home',
        'fields'     => array(
            array(
                'id'       => 'opt-title-tabs_information',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'          => 'opt-slides-tabs_information',
                'type'        => 'slides',
                'title'       => __( 'Tabs địa chỉ liên hệ', 'redux-framework-demo' ),
                'subtitle'    => __( 'Unlimited slides with drag and drop sortings.', 'redux-framework-demo' ),
                'desc'        => __( 'This field will store all slides values into a multidimensional array to use into a foreach loop.', 'redux-framework-demo' ),
                'placeholder' => array(
                    'title'       => __( 'This is a title', 'redux-framework-demo' ),
            ...
            array(         
                'id'       => 'opt-background-tabs_information',
                'type'     => 'background',
                'title'    => __('Body Background', 'redux-framework-demo'),
                'subtitle' => __('Body background with image, color, etc.', 'redux-framework-demo'),
                'output'   => array('#wrapper_contact_information'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            array(
                'id'       => 'opt-banner-page_contact',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Ảnh Banner', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Image you want as Banner.', 'redux-framework-demo' )
            ),
            array(
                'id'       => 'opt-title-form_contact',
                'type'     => 'text',
                'title'    => __( 'Tiêu đề Form', 'redux-framework-demo' ),
                'default'  => '',
            ),
            array(
                'id'       => 'opt-image-form_contact',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Ảnh Form', 'redux-framework-demo' ),
                'compiler' => 'true',
