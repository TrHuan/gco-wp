<?php
/**
 * Template Name: Page Sale Product
 *
 *
...
<section id="wrapper_saleproduct">
	<div class="background-overlay">
		<div class="container">
			<div class="row main_saleproduct">
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 sidebar_saleproduct">
					<div class="sidebar" role="complementary">
						<?php dynamic_sidebar('sidebar-woocommerce'); ?>
					</div><!-- #saleproduct -->
				</div>
				<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 content_saleproduct">
					<h2 class="tit-section-carousel">Sản phẩm khuyến mãi</h2>
