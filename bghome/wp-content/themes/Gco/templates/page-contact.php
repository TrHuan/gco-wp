...
<section id="banner-featured_page" class="fadeIn wow" data-wow-delay="0.2s">
   ...
   <img src="<?php echo $vz_options['opt-banner-page_contact']['url'];?>" alt="<?php the_title();?>">
	...
	<?php if( have_posts()) :  the_post();?>
	    <div class="background-overlay">
			<div class="box__contact_forms">
	    		...
	    		<div class="image-form_contact"><img src="<?php echo $vz_options['opt-image-form_contact']['url'];?>" alt="Liên hệ"></div>
			</div>
	    </div>
    <?php endif;?>		
</section>
