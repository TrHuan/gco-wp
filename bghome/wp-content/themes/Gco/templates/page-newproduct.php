<?php
/**
 * Template Name: Page New Product
 *
 *
...
<section id="wrapper_newproduct">
	<div class="background-overlay">
		<div class="container">
			<div class="row main_newproduct">
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 sidebar_newproduct">
					<div class="sidebar" role="complementary">
						<?php dynamic_sidebar('sidebar-woocommerce'); ?>
					</div><!-- #newproduct -->
				</div>
				<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 content_newproduct">
					<h2 class="tit-section-carousel">Sản phẩm mới</h2>
