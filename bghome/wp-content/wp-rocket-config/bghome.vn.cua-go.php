...
$rocket_secret_cache_key = '645df81a08ed5615466297';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/cua-go/thanh-toan/(.*)|/cua-go/gio-hang/|/cua-go/tai-khoan/(.*)|/cua-go/wc-api/v(.*)|(/[^/]+)?/(index\.php/)?wp\-json(/.*|$)|/cua-go/bgh-login/';
