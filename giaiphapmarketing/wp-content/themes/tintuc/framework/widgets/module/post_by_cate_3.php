<?php
add_action('widgets_init', 'eweb_post_by_cate_3');
function eweb_post_by_cate_3() {
        register_widget('eweb_post_by_cate_3');
}
class eweb_post_by_cate_3 extends WP_Widget {
	/*-----------------------------------------------------------------------------------*/
	/*	Widget Setup
	/*-----------------------------------------------------------------------------------*/
    function __construct() {
        $widget_ops = array(
            'classname' => 'item-cate-2 item-cate-3',
            'description' => 'Bài viết theo chuyên mục 3 (Sidebar)'
        );
        parent::__construct('eweb_post_by_cate_3', 'EW: Bài viết theo chuyên mục 3', $widget_ops);
    }
