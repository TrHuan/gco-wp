            ...
            <div class="row">
              <div class="col-lg-8 col-sm-8 col-xs-12">
                <ul class="left">
                  ...
                  <?php }else{
                    ?>
                  <li <?php if($i>4){ ?> class="hidden-md hidden-lg hidden-sm" <?php } ?>>
                    <a class="thumbnail" href="<?php the_permalink();?>" title="<?php the_title();?>">
              ...
              <div class="col-lg-4 col-sm-4 hidden-xs scroll-div">
                <ul class="right">
                  <?php
                  $args = array(
                    'showposts' => 10,
                  ...
                  <li <?php post_class($class);?>>
                                                <a class="thumbnail" href="<?php the_permalink();?>" title="<?php the_title();?>">
                                                  ...
                                                  ?>
                                                  <div class="home-date"><?php printf( '%s', '<span>' . get_the_date('d/m/Y') . '</span>' );?> | <?php echo $cate; ?></div>
                                                </li>
