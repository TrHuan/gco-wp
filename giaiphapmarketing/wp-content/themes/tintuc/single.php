      ...
      <div class="row">
        ...
        <div class="post-content">
          ...
          <div class="scroll-sidebar test">
            ...
            ?>
            <?php if (function_exists('z_taxonomy_image_url')) echo '<a href="" target="_blank"><img src="'.z_taxonomy_image_url($category[0]->term_id).'"></a>' ?>
          </div>
          <div class="entry-content">
            ...
            echo '<section class="short-des">'.get_the_excerpt().'</section>';
            the_content();
                                    //}
